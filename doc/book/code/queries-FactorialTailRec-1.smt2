...
;;; End module FStar.Pervasives.Native (1325 decls; total size 133099)
...
;;; End interface FStar.Pervasives (1419 decls; total size 84389)
...
;;; End interface FStar.Ghost (168 decls; total size 9269)
...
;;; End module FStar.Mul (8 decls; total size 971)

; Internals for FactorialTailRec

(push)

; encoding sigelt factorial


; <Start encoding FactorialTailRec.factorial>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun FactorialTailRec.factorial.fuel_instrumented (Fuel Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun FactorialTailRec.factorial.fuel_instrumented_token () Term)
(declare-fun FactorialTailRec.factorial (Term) Term)
(declare-fun FactorialTailRec.factorial@tok () Term)
;;;;;;;;;;;;;;;;n: Prims.nat -> Prims.GTot Prims.nat
(declare-fun Tm_ghost_arrow_490632d46c9d8077fe058e4df7d3e4ee () Term)
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: FactorialTailRec.factorial
;;; Fact-ids: Name FactorialTailRec.factorial; Namespace FactorialTailRec
(assert (! 
;; def=FactorialTailRec.fst(6,8-6,17); use=FactorialTailRec.fst(6,8-6,17)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasType @x1
Prims.nat)
(= (FactorialTailRec.factorial.fuel_instrumented (SFuel @u0)
@x1)
...
(FactorialTailRec.factorial.fuel_instrumented @u0
(Prims.op_Subtraction @x1
(BoxInt 1))))))))
 :weight 0


:pattern ((FactorialTailRec.factorial.fuel_instrumented (SFuel @u0)
@x1))
:qid equation_with_fuel_FactorialTailRec.factorial.fuel_instrumented))

:named equation_with_fuel_FactorialTailRec.factorial.fuel_instrumented))
;;;;;;;;;;;;;;;;Fuel irrelevance
;;; Fact-ids: Name FactorialTailRec.factorial; Namespace FactorialTailRec
(assert (! 
;; def=FactorialTailRec.fst(6,8-6,17); use=FactorialTailRec.fst(6,8-6,17)
(forall ((@u0 Fuel) (@x1 Term))
 (! (= (FactorialTailRec.factorial.fuel_instrumented (SFuel @u0)
@x1)
(FactorialTailRec.factorial.fuel_instrumented ZFuel
@x1))
 

:pattern ((FactorialTailRec.factorial.fuel_instrumented (SFuel @u0)
@x1))
:qid @fuel_irrelevance_FactorialTailRec.factorial.fuel_instrumented))

:named @fuel_irrelevance_FactorialTailRec.factorial.fuel_instrumented))
;;;;;;;;;;;;;;;;Correspondence of recursive function to instrumented version
;;; Fact-ids: Name FactorialTailRec.factorial; Namespace FactorialTailRec
(assert (! 
;; def=FactorialTailRec.fst(6,8-6,17); use=FactorialTailRec.fst(6,8-6,17)
(forall ((@x0 Term))
 (! (= (FactorialTailRec.factorial @x0)
(FactorialTailRec.factorial.fuel_instrumented MaxFuel
@x0))
 

:pattern ((FactorialTailRec.factorial @x0))
:qid @fuel_correspondence_FactorialTailRec.factorial.fuel_instrumented))

:named @fuel_correspondence_FactorialTailRec.factorial.fuel_instrumented))

; </end encoding FactorialTailRec.factorial>


; Starting query at FactorialTailRec.fst(14,4-15,41)

(push)
;;;;;;;;;;;;;;;;n#659 : Prims.nat (Prims.nat)
...
(declare-fun Tm_refine_aefc60e45aa6492f4639dd4c33b54789 (Term) Term)
(declare-fun FactorialTailRec.factorial_tail (Term Term) Term)

(declare-fun Tm_refine_8ae593f82d392c4cf2215e799ebb1237 (Term Term) Term)
;;;;;;;;;;;;;;;;n: Prims.nat -> out: Prims.nat{n << n \/ n === n /\ out << out}   -> r: Prims.nat{r == out * factorial n}
(declare-fun Tm_arrow_43421b33f894b86d749d7def8e6a24b3 () Term)
(declare-fun FactorialTailRec.factorial_tail@tok () Term)
...
(declare-fun Tm_refine_f6c37a12260c9117a9c79c7f73de57aa () Term)
(declare-fun Tm_refine_da367d9a9dd1b377dc5c03c935e8319e () Term)

; Encoding query formula : (n = 0 == true ==> out == out * FactorialTailRec.factorial n) /\
; (~(n = 0 = true) ==>
;   (forall (b: Prims.bool).
;       n = 0 == b ==>
;       n - 1 >= 0 /\
...
;           return_val == n - 1 ==>
;           n * out >= 0 /\ (n - 1 << n \/ n - 1 === n /\ n * out << out) /\
;           (forall (return_val: out: Prims.nat{n - 1 << n \/ n - 1 === n /\ out << out}).
;               return_val == n * out ==>
;               (forall (any_result:
;                   r: Prims.nat{r == (n * out) * FactorialTailRec.factorial (n - 1)}).
;                   FactorialTailRec.factorial_tail (n - 1) (n * out) == any_result ==>
;                   FactorialTailRec.factorial_tail (n - 1) (n * out) ==
;                   (n * out) * FactorialTailRec.factorial (n - 1) ==>
;                   FactorialTailRec.factorial_tail (n - 1) (n * out) ==
;                   out * FactorialTailRec.factorial n)))))
...
;;; Fact-ids: 
(assert (! (not 
;; def=prims.fst(368,2-368,39); use=FactorialTailRec.fst(14,4-15,41)
(and (implies 
;; def=FactorialTailRec.fst(14,7-14,12); use=FactorialTailRec.fst(14,7-14,12)
...
;; def=FactorialTailRec.fst(13,17-13,39); use=FactorialTailRec.fst(14,18-14,21)
(or label_1

;; def=FactorialTailRec.fst(13,17-13,39); use=FactorialTailRec.fst(14,18-14,21)
(= x_bb4e1c9af0265270f8e7a5f250f730e2_1
(Prims.op_Multiply x_bb4e1c9af0265270f8e7a5f250f730e2_1
(FactorialTailRec.factorial x_bb4e1c9af0265270f8e7a5f250f730e2_0)))
)
)
(implies 
;; def=prims.fst(368,19-368,21); use=FactorialTailRec.fst(14,4-15,41)
(not 
;; def=FactorialTailRec.fst(14,7-14,12); use=FactorialTailRec.fst(14,7-14,12)
(= (Prims.op_Equality Prims.int
x_bb4e1c9af0265270f8e7a5f250f730e2_0
...
;; def=prims.fst(392,99-392,120); use=FactorialTailRec.fst(14,4-15,41)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
Prims.bool)

;; def=FactorialTailRec.fst(14,7-15,41); use=FactorialTailRec.fst(14,7-15,41)
(= (Prims.op_Equality Prims.int
x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 0))
@x0)
...
;; def=prims.fst(438,77-438,89); use=FactorialTailRec.fst(14,4-15,41)
(and 
;; def=prims.fst(659,18-659,24); use=FactorialTailRec.fst(15,24-15,31)
(or label_2
...
;; def=prims.fst(335,2-335,58); use=FactorialTailRec.fst(14,4-15,41)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
Prims.nat)

;; def=prims.fst(335,26-335,41); use=FactorialTailRec.fst(14,4-15,41)
(= @x1
...
;; def=prims.fst(438,77-438,89); use=FactorialTailRec.fst(14,4-15,41)
(and 
;; def=prims.fst(659,18-659,24); use=FactorialTailRec.fst(15,32-15,41)
(or label_3

;; def=prims.fst(659,18-659,24); use=FactorialTailRec.fst(15,32-15,41)
(>= (BoxInt_proj_0 (Prims.op_Multiply x_bb4e1c9af0265270f8e7a5f250f730e2_0
x_bb4e1c9af0265270f8e7a5f250f730e2_1))
(BoxInt_proj_0 (BoxInt 0)))
)


;; def=FactorialTailRec.fst(12,24-15,41); use=FactorialTailRec.fst(15,32-15,41)
(or label_4

;; def=FactorialTailRec.fst(14,4-15,41); use=FactorialTailRec.fst(15,32-15,41)
(Valid 
;; def=FactorialTailRec.fst(14,4-15,41); use=FactorialTailRec.fst(15,32-15,41)
...
;; def=FactorialTailRec.fst(12,24-15,41); use=FactorialTailRec.fst(15,32-15,41)
(and 
;; def=FactorialTailRec.fst(12,24-12,25); use=FactorialTailRec.fst(15,32-15,41)
(Valid 
;; def=FactorialTailRec.fst(12,24-12,25); use=FactorialTailRec.fst(15,32-15,41)
...
(Prims.precedes Prims.nat
Prims.nat
(Prims.op_Multiply x_bb4e1c9af0265270f8e7a5f250f730e2_0
x_bb4e1c9af0265270f8e7a5f250f730e2_1)
x_bb4e1c9af0265270f8e7a5f250f730e2_1)
)
)
...
Tm_refine_f6c37a12260c9117a9c79c7f73de57aa)
...
;; def=prims.fst(430,66-430,102); use=FactorialTailRec.fst(14,4-15,41)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Tm_refine_da367d9a9dd1b377dc5c03c935e8319e)

;; def=FactorialTailRec.fst(13,8-15,41); use=FactorialTailRec.fst(14,4-15,41)
(= (FactorialTailRec.factorial_tail (Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 1))
(Prims.op_Multiply x_bb4e1c9af0265270f8e7a5f250f730e2_0
x_bb4e1c9af0265270f8e7a5f250f730e2_1))
@x3)
...
;; def=FactorialTailRec.fst(13,17-13,39); use=FactorialTailRec.fst(15,9-15,41)
(= (FactorialTailRec.factorial_tail (Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 1))
(Prims.op_Multiply x_bb4e1c9af0265270f8e7a5f250f730e2_0
x_bb4e1c9af0265270f8e7a5f250f730e2_1))
(Prims.op_Multiply (Prims.op_Multiply x_bb4e1c9af0265270f8e7a5f250f730e2_0
x_bb4e1c9af0265270f8e7a5f250f730e2_1)
(FactorialTailRec.factorial (Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 1)))))
)
