...
; UNSAT CORE: @MaxIFuel_assumption, @query, int_inversion, primitive_Prims.op_Addition, primitive_Prims.op_Equality, primitive_Prims.op_Modulus, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0

;;; End module Prims (645 decls; total size 34513)
...
;;; End module FStar.Pervasives.Native (1325 decls; total size 132587)
...
;;; End interface FStar.Pervasives (1419 decls; total size 83877)
...
;;; End module FStar.Mul (8 decls; total size 459)

; Internals for Part1.GettingOffTheGround
...
; <Start encoding Part1.GettingOffTheGround.incr>

(declare-fun Part1.GettingOffTheGround.incr (Term) Term)

(declare-fun Part1.GettingOffTheGround.incr@tok () Term)

; </end encoding Part1.GettingOffTheGround.incr>


; encoding sigelt incr1


; <Start encoding Part1.GettingOffTheGround.incr1>

(declare-fun Part1.GettingOffTheGround.incr1 (Term) Term)
(declare-fun Tm_refine_25948cf2cb84e8edfffe30eaf3d63408 (Term) Term)
;;;;;;;;;;;;;;;;x: Prims.int -> y: Prims.int{y > x}
(declare-fun Tm_arrow_6de1cd8520077b246198403d4f0f1b21 () Term)
(declare-fun Part1.GettingOffTheGround.incr1@tok () Term)


; </end encoding Part1.GettingOffTheGround.incr1>


; encoding sigelt incr3


; <Start encoding Part1.GettingOffTheGround.incr3>

(declare-fun Part1.GettingOffTheGround.incr3 (Term) Term)
;;;;;;;;;;;;;;;;x: Prims.nat -> Prims.nat
(declare-fun Tm_arrow_b71b847c8a1dce9fbabbfc40fd470d89 () Term)
(declare-fun Part1.GettingOffTheGround.incr3@tok () Term)

; </end encoding Part1.GettingOffTheGround.incr3>


; encoding sigelt incr4


; <Skipped Part1.GettingOffTheGround.incr4/>


; encoding sigelt incr4


; <Start encoding Part1.GettingOffTheGround.incr4>

(declare-fun Part1.GettingOffTheGround.incr4 (Term) Term)

(declare-fun Part1.GettingOffTheGround.incr4@tok () Term)

; </end encoding Part1.GettingOffTheGround.incr4>


; encoding sigelt incr5


; <Start encoding Part1.GettingOffTheGround.incr5>

(declare-fun Part1.GettingOffTheGround.incr5 (Term) Term)
(declare-fun Tm_refine_1c0a3cec866ea42686274915ee561bf7 (Term) Term)
;;;;;;;;;;;;;;;;x: Prims.int -> y: Prims.int{y = x + 1}
(declare-fun Tm_arrow_205653a1eb9edf209d2ee538e08efac3 () Term)
(declare-fun Part1.GettingOffTheGround.incr5@tok () Term)


; </end encoding Part1.GettingOffTheGround.incr5>


; encoding sigelt incr6


; <Start encoding Part1.GettingOffTheGround.incr6>

(declare-fun Part1.GettingOffTheGround.incr6 (Term) Term)
(declare-fun Tm_refine_83d137c6bcbf9ef8eb573a2231b4db12 (Term) Term)
;;;;;;;;;;;;;;;;x: Prims.int -> y: Prims.int{x = y - 1}
(declare-fun Tm_arrow_62320d4dac2b922a89b3d1b9a6fe462c () Term)
(declare-fun Part1.GettingOffTheGround.incr6@tok () Term)


; </end encoding Part1.GettingOffTheGround.incr6>


; Starting query at Part1.GettingOffTheGround.fst(31,66-31,71)
...
;   Prims.auto_squash (match x % 2 = 0 with
;       | true -> (x + 1) % 2 = 1
;       | _ -> (x + 1) % 2 = 0)
...
(assert (! (not (forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.int)
(let ((@lb1 (Prims.op_Equality Prims.int
(Prims.op_Modulus @x0
(BoxInt 2))
(BoxInt 0))))
(ite (= @lb1
...
;; def=Part1.GettingOffTheGround.fst(31,42-31,49); use=Part1.GettingOffTheGround.fst(31,66-31,71)
(or label_1

;; def=Part1.GettingOffTheGround.fst(31,42-31,49); use=Part1.GettingOffTheGround.fst(31,66-31,71)
(= (Prims.op_Modulus (Prims.op_Addition @x0
(BoxInt 1))
(BoxInt 2))
(BoxInt 1))
)
...
;; def=Part1.GettingOffTheGround.fst(31,55-31,62); use=Part1.GettingOffTheGround.fst(31,66-31,71)
(or label_2
