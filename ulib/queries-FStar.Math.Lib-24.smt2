...
(assert (! 
;; def=prims.fst(477,6-477,9); use=prims.fst(477,6-477,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
...
;; def=prims.fst(477,52-477,68); use=prims.fst(477,52-477,68)
(and 
;; def=prims.fst(477,52-477,58); use=prims.fst(477,52-477,58)
(= @x0
@x1)


;; def=prims.fst(477,62-477,68); use=prims.fst(477,62-477,68)
(= @x2
@x3)
)
)
...
; UNSAT CORE: @MaxFuel_assumption, @MaxIFuel_assumption, @fuel_correspondence_FStar.Math.Lib.powx.fuel_instrumented, @fuel_irrelevance_FStar.Math.Lib.powx.fuel_instrumented, @query, Prims_pretyping_ae567c2fb75be05905677af440075565, binder_x_ae567c2fb75be05905677af440075565_0, binder_x_bb4e1c9af0265270f8e7a5f250f730e2_1, binder_x_bb4e1c9af0265270f8e7a5f250f730e2_2, equation_Prims.nat, equation_Prims.op_Equals_Equals_Equals, equation_with_fuel_FStar.Math.Lib.powx.fuel_instrumented, function_token_typing_Prims.__cache_version_number__, int_inversion, int_typing, primitive_Prims.op_Addition, primitive_Prims.op_Multiply, primitive_Prims.op_Subtraction, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, typing_FStar.Math.Lib.powx, well-founded-ordering-on-nat

;;; End module Prims (652 decls; total size 38119)
...
;;; End module FStar.Pervasives.Native (1325 decls; total size 133191)
...
;;; End interface FStar.Pervasives (1419 decls; total size 84481)
...
;;; End module FStar.Mul (8 decls; total size 1063)

; Internals for FStar.Math.Lib

(push)

; encoding sigelt lemma_div_def
...
; encoding sigelt slash_decr_axiom
...
; encoding sigelt lemma_mul_minus_distr_l
...
; encoding sigelt slash_star_axiom
...
(HasType @x1
Prims.nat))
(HasType (FStar.Math.Lib.powx @x0
@x1)
Prims.int))
...
@x1))
:qid typing_FStar.Math.Lib.powx))

:named typing_FStar.Math.Lib.powx))
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: FStar.Math.Lib.powx
;;; Fact-ids: Name FStar.Math.Lib.powx; Namespace FStar.Math.Lib
(assert (! 
;; def=FStar.Math.Lib.fst(59,8-59,12); use=FStar.Math.Lib.fst(59,8-59,12)
...
(FStar.Math.Lib.powx.fuel_instrumented @u0
@x1
(Prims.op_Subtraction @lb3
(BoxInt 1))))))))
 :weight 0
...
@x1
@x2))
:qid equation_with_fuel_FStar.Math.Lib.powx.fuel_instrumented))

:named equation_with_fuel_FStar.Math.Lib.powx.fuel_instrumented))
;;;;;;;;;;;;;;;;Fuel irrelevance
;;; Fact-ids: Name FStar.Math.Lib.powx; Namespace FStar.Math.Lib
(assert (! 
;; def=FStar.Math.Lib.fst(59,8-59,12); use=FStar.Math.Lib.fst(59,8-59,12)
...
; encoding sigelt arithmetic_shift_right
...
;;;;;;;;;;;;;;;;v: Prims.int -> i: Prims.nat -> res: Prims.int{res = div v (Prims.pow2 i)}
...
;;;;;;;;;;;;;;;;v: Prims.int -> p: Prims.pos -> res: Prims.int{res = v - div_non_eucl v p * p}
...
; encoding sigelt op_Plus_Percent
...
; encoding sigelt powx_lemma2


; <Skipped FStar.Math.Lib.powx_lemma2/>


; Starting query at FStar.Math.Lib.fst(123,27-127,63)

(push)
;;;;;;;;;;;;;;;;x#9562 : Prims.int (Prims.int)
...
;                 return_val == n - 1 ==>
;                 (x << x \/ x === x /\ (n - 1 << n \/ n - 1 === n /\ m << m)) /\
;                 (forall (any_result: Prims.nat).
;                     m == any_result ==>
;                     (forall (pure_result: Prims.unit).
;                         FStar.Math.Lib.powx x (n - 1) * FStar.Math.Lib.powx x m =
;                         FStar.Math.Lib.powx x (n - 1 + m) ==>
;                         n - 1 >= 0 /\
;                         (forall (return_val: Prims.nat).
;                             return_val == n - 1 ==>
;                             (forall (any_result: Prims.int).
;                                 FStar.Math.Lib.powx x (n - 1) == any_result ==>
;                                 (forall (pure_result: Prims.unit).
;                                     (x * FStar.Math.Lib.powx x (n - 1)) * FStar.Math.Lib.powx x m ==
;                                     x * (FStar.Math.Lib.powx x (n - 1) * FStar.Math.Lib.powx x m) ==>
;                                     k pure_result)))))))))
...
;;; Fact-ids: 
(assert (! (not 
;; def=FStar.Math.Lib.fst(123,27-127,63); use=FStar.Math.Lib.fst(123,27-127,63)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post Prims.unit))

;; def=prims.fst(420,36-420,97); use=FStar.Math.Lib.fst(123,27-127,63)
(forall ((@x1 Term))
 (! (implies (and (or label_1
(HasType @x1
Prims.unit))

;; def=FStar.Math.Lib.fst(122,2-122,40); use=FStar.Math.Lib.fst(123,27-127,63)
(or label_2

;; def=FStar.Math.Lib.fst(122,2-122,40); use=FStar.Math.Lib.fst(123,27-127,63)
(= (Prims.op_Multiply (FStar.Math.Lib.powx x_ae567c2fb75be05905677af440075565_0
x_bb4e1c9af0265270f8e7a5f250f730e2_1)
(FStar.Math.Lib.powx x_ae567c2fb75be05905677af440075565_0
x_bb4e1c9af0265270f8e7a5f250f730e2_2))
(FStar.Math.Lib.powx x_ae567c2fb75be05905677af440075565_0
(Prims.op_Addition x_bb4e1c9af0265270f8e7a5f250f730e2_1
x_bb4e1c9af0265270f8e7a5f250f730e2_2)))
)
)

;; def=prims.fst(420,83-420,96); use=FStar.Math.Lib.fst(123,27-127,63)
(Valid 
;; def=prims.fst(420,83-420,96); use=FStar.Math.Lib.fst(123,27-127,63)
(ApplyTT @x0
@x1)
...
;; def=prims.fst(438,77-438,89); use=FStar.Math.Lib.fst(123,27-127,63)
(and 
;; def= dummy(0,0-0,0); use=FStar.Math.Lib.fst(123,27-127,63)
...
;; def=prims.fst(385,51-385,91); use=FStar.Math.Lib.fst(123,27-127,63)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(Prims.pure_post Prims.unit))

;; def=prims.fst(420,36-420,97); use=FStar.Math.Lib.fst(124,55-124,57)
(forall ((@x5 Term))
 (! (implies (and (or label_3
(HasType @x5
Prims.unit))

;; def=FStar.Math.Lib.fst(124,32-124,52); use=FStar.Math.Lib.fst(124,55-124,57)
(or label_4
...
;; def=prims.fst(420,83-420,96); use=FStar.Math.Lib.fst(124,55-124,57)
(Valid 
;; def=prims.fst(420,83-420,96); use=FStar.Math.Lib.fst(124,55-124,57)
(ApplyTT @x4
@x5)
...
;; def=prims.fst(430,66-430,102); use=FStar.Math.Lib.fst(123,27-127,63)
(forall ((@x5 Term))
 (! (implies (HasType @x5
Prims.unit)

;; def=prims.fst(430,90-430,102); use=FStar.Math.Lib.fst(123,27-127,63)
(Valid 
;; def=prims.fst(430,90-430,102); use=FStar.Math.Lib.fst(123,27-127,63)
(ApplyTT @x4
@x5)
...
;; def=prims.fst(381,2-381,97); use=FStar.Math.Lib.fst(123,27-127,63)
(forall ((@x2 Term))
...
(forall ((@x3 Term))
 (! (implies 
;; def=prims.fst(381,73-381,79); use=FStar.Math.Lib.fst(123,27-127,63)
(Valid 
;; def=prims.fst(381,73-381,79); use=FStar.Math.Lib.fst(123,27-127,63)
(ApplyTT @x0
@x3)
...
;; def=prims.fst(381,84-381,87); use=FStar.Math.Lib.fst(123,27-127,63)
(Valid 
;; def=prims.fst(381,84-381,87); use=FStar.Math.Lib.fst(123,27-127,63)
(ApplyTT @x2
@x3)
...
;; def=prims.fst(368,2-368,39); use=FStar.Math.Lib.fst(123,27-127,63)
(and (implies 
;; def=FStar.Math.Lib.fst(123,22-126,5); use=FStar.Math.Lib.fst(125,8-126,5)
(= x_bb4e1c9af0265270f8e7a5f250f730e2_1
(BoxInt 0))
...
(implies 
;; def=prims.fst(368,19-368,21); use=FStar.Math.Lib.fst(123,27-127,63)
(not 
;; def=FStar.Math.Lib.fst(123,22-126,5); use=FStar.Math.Lib.fst(125,8-126,5)
(= x_bb4e1c9af0265270f8e7a5f250f730e2_1
(BoxInt 0))
...
;; def=prims.fst(392,99-392,120); use=FStar.Math.Lib.fst(123,27-127,63)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.int)

;; def=FStar.Math.Lib.fst(123,22-127,5); use=FStar.Math.Lib.fst(125,8-127,5)
(= x_bb4e1c9af0265270f8e7a5f250f730e2_1
@x3)
)
...
;; def=prims.fst(438,77-438,89); use=FStar.Math.Lib.fst(123,27-127,63)
(and 
;; def=prims.fst(659,18-659,24); use=FStar.Math.Lib.fst(127,23-127,28)
(or label_5
...
;; def=prims.fst(335,2-335,58); use=FStar.Math.Lib.fst(123,27-127,63)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.nat)

;; def=prims.fst(335,26-335,41); use=FStar.Math.Lib.fst(123,27-127,63)
(= @x4
...
;; def=prims.fst(438,77-438,89); use=FStar.Math.Lib.fst(123,27-127,63)
(and 
;; def=FStar.Math.Lib.fst(121,17-127,63); use=FStar.Math.Lib.fst(127,29-127,30)
(or label_6

;; def=FStar.Math.Lib.fst(123,27-127,63); use=FStar.Math.Lib.fst(127,29-127,30)
(Valid 
;; def=FStar.Math.Lib.fst(123,27-127,63); use=FStar.Math.Lib.fst(127,29-127,30)
...
;; def=FStar.Math.Lib.fst(121,17-127,63); use=FStar.Math.Lib.fst(127,29-127,30)
(and 
;; def=FStar.Math.Lib.fst(121,17-123,21); use=FStar.Math.Lib.fst(127,29-127,30)
(Valid 
;; def=FStar.Math.Lib.fst(121,17-123,21); use=FStar.Math.Lib.fst(127,29-127,30)
...
;; def=FStar.Math.Lib.fst(121,26-127,63); use=FStar.Math.Lib.fst(127,29-127,30)
(or 
;; def=FStar.Math.Lib.fst(123,27-127,63); use=FStar.Math.Lib.fst(127,29-127,30)
(Valid 
;; def=FStar.Math.Lib.fst(123,27-127,63); use=FStar.Math.Lib.fst(127,29-127,30)
...
;; def=FStar.Math.Lib.fst(121,26-127,63); use=FStar.Math.Lib.fst(127,29-127,30)
(and 
;; def=FStar.Math.Lib.fst(121,26-123,23); use=FStar.Math.Lib.fst(127,29-127,30)
(Valid 
;; def=FStar.Math.Lib.fst(121,26-123,23); use=FStar.Math.Lib.fst(127,29-127,30)
...
;; def=FStar.Math.Lib.fst(121,35-123,25); use=FStar.Math.Lib.fst(123,27-127,63)
(= x_bb4e1c9af0265270f8e7a5f250f730e2_2
@x5)
)

;; def=prims.fst(420,36-420,97); use=FStar.Math.Lib.fst(127,9-127,20)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.unit)

;; def=FStar.Math.Lib.fst(122,2-122,40); use=FStar.Math.Lib.fst(127,9-127,20)
(= (Prims.op_Multiply (FStar.Math.Lib.powx x_ae567c2fb75be05905677af440075565_0
(Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_1
(BoxInt 1)))
(FStar.Math.Lib.powx x_ae567c2fb75be05905677af440075565_0
x_bb4e1c9af0265270f8e7a5f250f730e2_2))
(FStar.Math.Lib.powx x_ae567c2fb75be05905677af440075565_0
(Prims.op_Addition (Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_1
(BoxInt 1))
x_bb4e1c9af0265270f8e7a5f250f730e2_2)))
)
...
;; def=prims.fst(438,77-438,89); use=FStar.Math.Lib.fst(123,27-127,63)
(and 
;; def=prims.fst(659,18-659,24); use=FStar.Math.Lib.fst(127,46-127,51)
(or label_7
...
;; def=FStar.Math.Lib.fst(124,13-127,52); use=FStar.Math.Lib.fst(124,13-127,52)
(= (FStar.Math.Lib.powx x_ae567c2fb75be05905677af440075565_0
(Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_1
(BoxInt 1)))
@x8)
...
;; def=prims.fst(420,36-420,97); use=FStar.Math.Lib.fst(127,32-127,35)
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
Prims.unit)

;; def=FStar.Math.Lib.fst(124,32-124,52); use=FStar.Math.Lib.fst(127,32-127,35)
(= (Prims.op_Multiply (Prims.op_Multiply x_ae567c2fb75be05905677af440075565_0
(FStar.Math.Lib.powx x_ae567c2fb75be05905677af440075565_0
(Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_1
(BoxInt 1))))
(FStar.Math.Lib.powx x_ae567c2fb75be05905677af440075565_0
x_bb4e1c9af0265270f8e7a5f250f730e2_2))
(Prims.op_Multiply x_ae567c2fb75be05905677af440075565_0
(Prims.op_Multiply (FStar.Math.Lib.powx x_ae567c2fb75be05905677af440075565_0
(Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_1
(BoxInt 1)))
(FStar.Math.Lib.powx x_ae567c2fb75be05905677af440075565_0
...
;; def=prims.fst(420,83-420,96); use=FStar.Math.Lib.fst(127,32-127,35)
(Valid 
;; def=prims.fst(420,83-420,96); use=FStar.Math.Lib.fst(127,32-127,35)
(ApplyTT @x2
@x9)
