...
(assert (! 
;; def=prims.fst(567,4-567,15); use=prims.fst(567,4-567,15)
...
;;; End module FStar.Pervasives.Native (1325 decls; total size 135702)
...
;;; End interface FStar.Pervasives (1419 decls; total size 86992)
...
;;; End interface FStar.Classical (203 decls; total size 17458)
...
;;; End module FStar.StrongExcludedMiddle (10 decls; total size 3941)
...
;;; End interface FStar.Classical.Sugar (136 decls; total size 10010)
...
;;; End module FStar.List.Tot.Base (675 decls; total size 90684)
...
;;; End module FStar.List.Tot.Properties (527 decls; total size 54720)
...
;;; End module FStar.List.Tot (3 decls; total size 3413)
...
;;; Fact-ids: Name FStar.Seq.Base.index; Namespace FStar.Seq.Base
(assert (! 
;; def=FStar.Seq.Base.fsti(28,4-28,9); use=FStar.Seq.Base.fsti(28,4-28,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(assert (! 
;; def=FStar.Seq.Base.fsti(30,4-30,10); use=FStar.Seq.Base.fsti(30,4-30,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(assert (! 
;; def=FStar.Seq.Base.fsti(52,4-52,7); use=FStar.Seq.Base.fsti(52,4-52,7)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
;; def=FStar.Seq.Base.fsti(63,11-63,36); use=FStar.Seq.Base.fsti(63,11-63,36)
...
(assert (! 
;; def=FStar.Seq.Base.fsti(86,46-86,67); use=FStar.Seq.Base.fsti(86,46-86,67)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
...
;; def=FStar.Seq.Base.fsti(86,54-86,66); use=FStar.Seq.Base.fsti(86,54-86,66)
(< (BoxInt_proj_0 @x2)
...
;; def=FStar.Seq.Base.fsti(88,11-88,42); use=FStar.Seq.Base.fsti(88,11-88,42)
(= (FStar.Seq.Base.length @x0
...
;; def=FStar.Seq.Base.fsti(93,11-93,58); use=FStar.Seq.Base.fsti(93,11-93,58)
(= (FStar.Seq.Base.length @x0
...
;; def=FStar.Seq.Base.fsti(104,11-104,38); use=FStar.Seq.Base.fsti(104,11-104,38)
...
;; def=FStar.Seq.Base.fsti(109,11-109,37); use=FStar.Seq.Base.fsti(109,11-109,37)
(= (FStar.Seq.Base.index @x0
(FStar.Seq.Base.upd @x0
@x1
@x2
...
(assert (! 
;; def=FStar.Seq.Base.fsti(112,74-112,101); use=FStar.Seq.Base.fsti(112,74-112,101)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
...
;; def=FStar.Seq.Base.fsti(112,80-112,84); use=FStar.Seq.Base.fsti(112,80-112,84)
(not (= @x1
@x2))


;; def=FStar.Seq.Base.fsti(112,88-112,100); use=FStar.Seq.Base.fsti(112,88-112,100)
(< (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (FStar.Seq.Base.length @x3
@x4)))
))
...
;; def=FStar.Seq.Base.fsti(114,11-114,45); use=FStar.Seq.Base.fsti(114,11-114,45)
(= (FStar.Seq.Base.index @x0
(FStar.Seq.Base.upd @x0
@x1
@x2
...
;; def=FStar.Seq.Base.fsti(119,11-119,49); use=FStar.Seq.Base.fsti(119,11-119,49)
(= (FStar.Seq.Base.index @x0
(FStar.Seq.Base.append @x0
@x1
@x2)
...
(assert (! 
;; def=FStar.Seq.Base.fsti(122,57-122,107); use=FStar.Seq.Base.fsti(122,57-122,107)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
...
;; def=FStar.Seq.Base.fsti(122,63-122,88); use=FStar.Seq.Base.fsti(122,63-122,88)
(< (BoxInt_proj_0 @x1)
...
;; def=FStar.Seq.Base.fsti(122,92-122,106); use=FStar.Seq.Base.fsti(122,92-122,106)
(<= (BoxInt_proj_0 (FStar.Seq.Base.length @x2
@x3))
(BoxInt_proj_0 @x1))
))
...
;; def=FStar.Seq.Base.fsti(124,11-124,63); use=FStar.Seq.Base.fsti(124,11-124,63)
(= (FStar.Seq.Base.index @x0
(FStar.Seq.Base.append @x0
@x1
@x2)
...
;;; End interface FStar.Seq.Base (278 decls; total size 32404)
...
;;; End interface FStar.Seq.Properties (842 decls; total size 79021)
...
;;; End module FStar.Seq (3 decls; total size 3403)
...
;;; End interface FStar.Sealed (17 decls; total size 4197)
...
;;; End interface FStar.Range (22 decls; total size 4535)
...
;;; End module FStar.Preorder (56 decls; total size 5755)
...
;;; End interface FStar.Calc (50 decls; total size 6333)
...
;;; End module FStar.Mul (8 decls; total size 3574)
...
;;; End module FStar.Math.Lib (158 decls; total size 16047)
...
;;; End module FStar.Math.Lemmas (616 decls; total size 55298)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.BitVector.elem_vec; Namespace FStar.BitVector
(assert (! 
;; def=FStar.BitVector.fst(39,4-39,12); use=FStar.BitVector.fst(39,4-39,12)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Prims.pos)
(HasType @x1
(Tm_refine_c1424615841f28cac7fc34e92b7ff33c @x0)))
(HasType (FStar.BitVector.elem_vec @x0
@x1)
(FStar.BitVector.bv_t @x0)))
 

:pattern ((FStar.BitVector.elem_vec @x0
@x1))
:qid typing_FStar.BitVector.elem_vec))

:named typing_FStar.BitVector.elem_vec))

;;;;;;;;;;;;;;;;Equation for FStar.BitVector.elem_vec
;;; Fact-ids: Name FStar.BitVector.elem_vec; Namespace FStar.BitVector
(assert (! 
;; def=FStar.BitVector.fst(39,4-39,12); use=FStar.BitVector.fst(39,4-39,12)
(forall ((@x0 Term) (@x1 Term))
 (! (= (FStar.BitVector.elem_vec @x0
@x1)
(FStar.Seq.Base.upd Prims.bool
...
:pattern ((FStar.BitVector.elem_vec @x0
@x1))
:qid equation_FStar.BitVector.elem_vec))

:named equation_FStar.BitVector.elem_vec))
...
;;; End module FStar.BitVector (158 decls; total size 20880)
...
;;; End interface FStar.UInt (720 decls; total size 58786)

; Internals for FStar.Int
...
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.Int.pow2_n; Namespace FStar.Int
(assert (! 
;; def=FStar.Int.fsti(67,20-67,36); use=FStar.Int.fsti(67,20-67,36)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_cf74cf5c1e7834b84db9cc7ebce886a3 @x2))
(and (HasTypeFuel @u0
@x1
Prims.nat)

;; def=FStar.Int.fsti(67,27-67,34); use=FStar.Int.fsti(67,27-67,34)
(< (BoxInt_proj_0 @x1)
...
@x1
(Tm_refine_cf74cf5c1e7834b84db9cc7ebce886a3 @x2)))
:qid refinement_interpretation_Tm_refine_cf74cf5c1e7834b84db9cc7ebce886a3))

:named refinement_interpretation_Tm_refine_cf74cf5c1e7834b84db9cc7ebce886a3))
(declare-fun FStar.Int.pow2_n (Term Term) Term)

;;;;;;;;;;;;;;;;p: Prims.nat{p < n - 1} -> int_t n
(declare-fun Tm_arrow_42409e57c55f2a2d0836412885dba252 () Term)
(declare-fun FStar.Int.pow2_n@tok () Term)
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.Int.pow2_n; Namespace FStar.Int
(assert (! 
;; def=FStar.Int.fsti(67,4-67,10); use=FStar.Int.fsti(67,4-67,10)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Prims.pos)
(HasType @x1
(Tm_refine_cf74cf5c1e7834b84db9cc7ebce886a3 @x0)))
(HasType (FStar.Int.pow2_n @x0
@x1)
(FStar.Int.int_t @x0)))
 

:pattern ((FStar.Int.pow2_n @x0
@x1))
:qid typing_FStar.Int.pow2_n))

:named typing_FStar.Int.pow2_n))

;;;;;;;;;;;;;;;;Equation for FStar.Int.pow2_n
;;; Fact-ids: Name FStar.Int.pow2_n; Namespace FStar.Int
(assert (! 
;; def=FStar.Int.fsti(67,4-67,10); use=FStar.Int.fsti(67,4-67,10)
(forall ((@x0 Term) (@x1 Term))
...
:pattern ((FStar.Int.pow2_n @x0
@x1))
:qid equation_FStar.Int.pow2_n))

:named equation_FStar.Int.pow2_n))

; </end encoding FStar.Int.pow2_n>


; encoding sigelt pow2_minus_one
...
;;;;;;;;;;;;;;;;n: Prims.pos{1 < n} -> int_t n
(declare-fun Tm_arrow_e2450f3af7bd5b3af47241cdfb1c2db6 () Term)
(declare-fun FStar.Int.one@tok () Term)

;;;;;;;;;;;;;;;;Equation for FStar.Int.one
;;; Fact-ids: Name FStar.Int.one; Namespace FStar.Int
(assert (! 
;; def=FStar.Int.fsti(74,4-74,7); use=FStar.Int.fsti(74,4-74,7)
(forall ((@x0 Term))
 (! (= (FStar.Int.one @x0)
(BoxInt 1))
 

:pattern ((FStar.Int.one @x0))
:qid equation_FStar.Int.one))

:named equation_FStar.Int.one))
...
; <Skipped FStar.Int.incr_underspec/>
...
; <Skipped FStar.Int.decr_underspec/>
...
;;;;;;;;;;;;;;;;a: int_t n -> b: int_t n -> Prims.Pure (int_t n)
...
; <Skipped FStar.Int.add_underspec/>
...
; <Skipped FStar.Int.sub_underspec/>
...
; <Skipped FStar.Int.mul_underspec/>
...
;;;;;;;;;;;;;;;;a: int_t n -> b: int_t n {b <> 0} -> Prims.Pure (int_t n)
...
; <Skipped FStar.Int.div_underspec/>
...
;;;;;;;;;;;;;;;;a: int_t n {min_int n < a} -> b: int_t n {b <> 0} -> c: int_t n {b <> 0 ==> a / b = c}
...
;;;;;;;;;;;;;;;;a: int_t n -> b: int_t n {b <> 0} -> int_t n
...
;;;;;;;;;;;;;;;;a: int_t n -> b: int_t n -> Prims.bool
...
; encoding sigelt to_uint


; <Start encoding FStar.Int.to_uint>

(declare-fun FStar.Int.to_uint (Term Term) Term)
;;;;;;;;;;;;;;;;x: int_t n -> FStar.UInt.uint_t n
(declare-fun Tm_arrow_3e678eb9a841c4f9b41c85aeb802f0f1 () Term)
(declare-fun FStar.Int.to_uint@tok () Term)
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.Int.to_uint; Namespace FStar.Int
(assert (! 
;; def=FStar.Int.fsti(190,4-190,11); use=FStar.Int.fsti(190,4-190,11)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Prims.pos)
(HasType @x1
(FStar.Int.int_t @x0)))
(HasType (FStar.Int.to_uint @x0
@x1)
(FStar.UInt.uint_t @x0)))
 

:pattern ((FStar.Int.to_uint @x0
@x1))
:qid typing_FStar.Int.to_uint))

:named typing_FStar.Int.to_uint))
;;;;;;;;;;;;;;;;Equation for FStar.Int.to_uint
;;; Fact-ids: Name FStar.Int.to_uint; Namespace FStar.Int
(assert (! 
;; def=FStar.Int.fsti(190,4-190,11); use=FStar.Int.fsti(190,4-190,11)
(forall ((@x0 Term) (@x1 Term))
 (! (= (FStar.Int.to_uint @x0
@x1)
(let ((@lb2 (Prims.op_LessThanOrEqual (BoxInt 0)
@x1)))
(ite (= @lb2
(BoxBool true))
@x1
...
:pattern ((FStar.Int.to_uint @x0
@x1))
:qid equation_FStar.Int.to_uint))

:named equation_FStar.Int.to_uint))

; </end encoding FStar.Int.to_uint>


; encoding sigelt from_uint


; <Start encoding FStar.Int.from_uint>

(declare-fun FStar.Int.from_uint (Term Term) Term)
;;;;;;;;;;;;;;;;x: FStar.UInt.uint_t n -> int_t n
...
; encoding sigelt to_uint_injective


; <Skipped FStar.Int.to_uint_injective/>
...
;;;;;;;;;;;;;;;;num: int_t n -> FStar.BitVector.bv_t n
(declare-fun Tm_arrow_45e09970c9488f8db22355eb21b4b697 () Term)
(declare-fun FStar.Int.to_vec@tok () Term)
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.Int.to_vec; Namespace FStar.Int
(assert (! 
;; def=FStar.Int.fsti(205,4-205,10); use=FStar.Int.fsti(205,4-205,10)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
Prims.pos)
(HasType @x1
(FStar.Int.int_t @x0)))
(HasType (FStar.Int.to_vec @x0
@x1)
(FStar.BitVector.bv_t @x0)))
 

:pattern ((FStar.Int.to_vec @x0
@x1))
:qid typing_FStar.Int.to_vec))

:named typing_FStar.Int.to_vec))
;;;;;;;;;;;;;;;;Equation for FStar.Int.to_vec
;;; Fact-ids: Name FStar.Int.to_vec; Namespace FStar.Int
(assert (! 
;; def=FStar.Int.fsti(205,4-205,10); use=FStar.Int.fsti(205,4-205,10)
(forall ((@x0 Term) (@x1 Term))
...
:pattern ((FStar.Int.to_vec @x0
@x1))
:qid equation_FStar.Int.to_vec))

:named equation_FStar.Int.to_vec))
...
;;;;;;;;;;;;;;;;vec: FStar.BitVector.bv_t n -> int_t n
...
; <Skipped FStar.Int.to_vec_lemma_1/>
...
; <Skipped FStar.Int.to_vec_lemma_2/>
...
; <Skipped FStar.Int.inverse_vec_lemma/>
...
; <Skipped FStar.Int.inverse_num_lemma/>
...
; <Skipped FStar.Int.from_vec_lemma_1/>
...
; <Skipped FStar.Int.from_vec_lemma_2/>
...
; encoding sigelt zero_to_vec_lemma


; <Skipped FStar.Int.zero_to_vec_lemma/>
...
; encoding sigelt zero_from_vec_lemma


; <Skipped FStar.Int.zero_from_vec_lemma/>
...
; encoding sigelt one_to_vec_lemma


; <Skipped FStar.Int.one_to_vec_lemma/>
...
; encoding sigelt pow2_to_vec_lemma


; <Skipped FStar.Int.pow2_to_vec_lemma/>


; Starting query at FStar.Int.fst(92,2-94,43)

(push)
;;;;;;;;;;;;;;;;n#26400 : Prims.pos (Prims.pos)
...
;;;;;;;;;;;;;;;;p#26401 : p: Prims.nat{p < n - 1} (p: Prims.nat{p < n - 1})
(declare-fun x_afc09461858c30ac5d755a25fcc944b2_1 () Term)
(declare-fun Tm_refine_f42042035fa9145c3fcdd0f8e31c49bd () Term)
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=FStar.Int.fsti(250,33-250,47); use=FStar.Int.fst(91,8-91,25)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_f42042035fa9145c3fcdd0f8e31c49bd)
(and (HasTypeFuel @u0
@x1
Prims.nat)

;; def=FStar.Int.fsti(250,39-250,46); use=FStar.Int.fst(91,8-91,25)
(< (BoxInt_proj_0 @x1)
(- (BoxInt_proj_0 x_f26957a7e62b271a8736230b1e9c83c1_0)
1))
))
...
@x1
Tm_refine_f42042035fa9145c3fcdd0f8e31c49bd))
:qid refinement_interpretation_Tm_refine_f42042035fa9145c3fcdd0f8e31c49bd))

:named refinement_interpretation_Tm_refine_f42042035fa9145c3fcdd0f8e31c49bd))
;;;;;;;;;;;;;;;;binder_x_afc09461858c30ac5d755a25fcc944b2_1
;;; Fact-ids: 
(assert (! (HasType x_afc09461858c30ac5d755a25fcc944b2_1
Tm_refine_f42042035fa9145c3fcdd0f8e31c49bd)
:named binder_x_afc09461858c30ac5d755a25fcc944b2_1))
;;;;;;;;;;;;;;;;i#26402 : i: Prims.nat{i < n} (i: Prims.nat{i < n})
(declare-fun x_a6ca6afaf28feca12f50f23fc064a6db_2 () Term)
(declare-fun Tm_refine_f61c88f7b091b2f36e8249b0c1c7337c () Term)
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=FStar.Int.fsti(250,51-250,63); use=FStar.Int.fst(91,8-91,25)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_f61c88f7b091b2f36e8249b0c1c7337c)
(and (HasTypeFuel @u0
@x1
Prims.nat)

;; def=FStar.Int.fsti(250,57-250,62); use=FStar.Int.fst(91,8-91,25)
(< (BoxInt_proj_0 @x1)
(BoxInt_proj_0 x_f26957a7e62b271a8736230b1e9c83c1_0))
))
...
@x1
Tm_refine_f61c88f7b091b2f36e8249b0c1c7337c))
:qid refinement_interpretation_Tm_refine_f61c88f7b091b2f36e8249b0c1c7337c))

:named refinement_interpretation_Tm_refine_f61c88f7b091b2f36e8249b0c1c7337c))
;;;;;;;;;;;;;;;;binder_x_a6ca6afaf28feca12f50f23fc064a6db_2
;;; Fact-ids: 
(assert (! (HasType x_a6ca6afaf28feca12f50f23fc064a6db_2
Tm_refine_f61c88f7b091b2f36e8249b0c1c7337c)
:named binder_x_a6ca6afaf28feca12f50f23fc064a6db_2))
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
...
(declare-fun Tm_refine_4c6622d20f912a60d11603c718f5193c () Term)
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=FStar.Int.fsti(250,33-250,47); use=FStar.Int.fst(94,7-94,24)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_4c6622d20f912a60d11603c718f5193c)
(and (HasTypeFuel @u0
@x1
Prims.nat)

;; def=FStar.Int.fsti(250,39-250,46); use=FStar.Int.fst(94,7-94,24)
(< (BoxInt_proj_0 @x1)
(- (- (BoxInt_proj_0 x_f26957a7e62b271a8736230b1e9c83c1_0)
1)
1))
...
@x1
Tm_refine_4c6622d20f912a60d11603c718f5193c))
:qid refinement_interpretation_Tm_refine_4c6622d20f912a60d11603c718f5193c))

:named refinement_interpretation_Tm_refine_4c6622d20f912a60d11603c718f5193c))
...
;       (i = n - 1 == true ==> (forall (any_result: Prims.unit). k any_result)) /\
;       (~(i = n - 1 = true) ==>
;         (forall (b: Prims.bool).
;             i = n - 1 == b ==>
;             (forall (k: Prims.pure_post Prims.unit).
...
;                           return_val == n - 1 ==>
;                           p - 1 >= 0 /\ p - 1 < n - 1 - 1 /\
;                           (forall (return_val: p: Prims.nat{p < n - 1 - 1}).
;                               return_val == p - 1 ==>
;                               (i < n ==>
;                                 i < n - 1 /\
;                                 (n - 1 << n \/ n - 1 === n /\ (p - 1 << p \/ p - 1 === p /\ i << i))
;                               ) /\
;                               (forall (any_result: i: Prims.nat{i < n}).
;                                   i == any_result ==>
;                                   (forall (pure_result: Prims.unit).
;                                       FStar.Seq.Base.index (FStar.Int.to_vec (FStar.Int.pow2_n (p -
;                                                   1)))
;                                         i =
;                                       FStar.Seq.Base.index (FStar.BitVector.elem_vec (n - 1 -
;                                               (p - 1) -
;                                               1))
;                                         i ==>
;                                       k pure_result))))))))))
...
;;; Fact-ids: 
(assert (! (not 
;; def=FStar.Int.fst(92,2-94,43); use=FStar.Int.fst(92,2-94,43)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post Prims.unit))

;; def=prims.fst(420,36-420,97); use=FStar.Int.fst(92,2-94,43)
(forall ((@x1 Term))
 (! (implies (and (or label_1
(HasType @x1
Prims.unit))

;; def=FStar.Int.fsti(252,17-252,83); use=FStar.Int.fst(92,2-94,43)
(or label_2

;; def=FStar.Int.fsti(252,17-252,83); use=FStar.Int.fst(92,2-94,43)
(= (FStar.Seq.Base.index Prims.bool
(FStar.Int.to_vec x_f26957a7e62b271a8736230b1e9c83c1_0
(FStar.Int.pow2_n x_f26957a7e62b271a8736230b1e9c83c1_0
x_afc09461858c30ac5d755a25fcc944b2_1))
x_a6ca6afaf28feca12f50f23fc064a6db_2)
(FStar.Seq.Base.index Prims.bool
(FStar.BitVector.elem_vec x_f26957a7e62b271a8736230b1e9c83c1_0
(BoxInt (- (- (BoxInt_proj_0 x_f26957a7e62b271a8736230b1e9c83c1_0)
(BoxInt_proj_0 x_afc09461858c30ac5d755a25fcc944b2_1))
1)))
x_a6ca6afaf28feca12f50f23fc064a6db_2))
)
)

;; def=prims.fst(420,83-420,96); use=FStar.Int.fst(92,2-94,43)
(Valid 
;; def=prims.fst(420,83-420,96); use=FStar.Int.fst(92,2-94,43)
(ApplyTT @x0
@x1)
...
;; def=prims.fst(381,2-381,97); use=FStar.Int.fst(92,2-94,43)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(Prims.pure_post Prims.unit))
...
(forall ((@x2 Term))
 (! (implies 
;; def=prims.fst(381,73-381,79); use=FStar.Int.fst(92,2-94,43)
(Valid 
;; def=prims.fst(381,73-381,79); use=FStar.Int.fst(92,2-94,43)
(ApplyTT @x0
@x2)
...
;; def=prims.fst(381,84-381,87); use=FStar.Int.fst(92,2-94,43)
(Valid 
;; def=prims.fst(381,84-381,87); use=FStar.Int.fst(92,2-94,43)
(ApplyTT @x1
@x2)
...
;; def=prims.fst(368,2-368,39); use=FStar.Int.fst(92,2-94,43)
(and (implies 
;; def=FStar.Int.fst(92,5-92,14); use=FStar.Int.fst(92,5-92,14)
(= (Prims.op_Equality Prims.int
x_a6ca6afaf28feca12f50f23fc064a6db_2
(BoxInt (- (BoxInt_proj_0 x_f26957a7e62b271a8736230b1e9c83c1_0)
1)))
...
;; def=prims.fst(430,66-430,102); use=FStar.Int.fst(92,2-94,43)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.unit)

;; def=prims.fst(430,90-430,102); use=FStar.Int.fst(92,2-94,43)
(Valid 
;; def=prims.fst(430,90-430,102); use=FStar.Int.fst(92,2-94,43)
(ApplyTT @x1
@x2)
...
(implies 
;; def=prims.fst(368,19-368,21); use=FStar.Int.fst(92,2-94,43)
(not 
;; def=FStar.Int.fst(92,5-92,14); use=FStar.Int.fst(92,5-92,14)
(= (Prims.op_Equality Prims.int
x_a6ca6afaf28feca12f50f23fc064a6db_2
...
;; def=prims.fst(392,99-392,120); use=FStar.Int.fst(92,2-94,43)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.bool)

;; def=FStar.Int.fst(92,5-94,43); use=FStar.Int.fst(92,5-94,43)
(= (Prims.op_Equality Prims.int
x_a6ca6afaf28feca12f50f23fc064a6db_2
(BoxInt (- (BoxInt_proj_0 x_f26957a7e62b271a8736230b1e9c83c1_0)
1)))
...
;; def=prims.fst(368,2-368,39); use=FStar.Int.fst(92,2-94,43)
(and (implies 
;; def=FStar.Int.fst(93,10-93,15); use=FStar.Int.fst(93,10-93,15)
(= (Prims.op_Equality Prims.int
x_afc09461858c30ac5d755a25fcc944b2_1
(BoxInt 0))
(BoxBool true))
...
;; def=prims.fst(438,77-438,89); use=FStar.Int.fst(92,2-94,43)
(and 
;; def=FStar.Int.fsti(245,29-245,34); use=FStar.Int.fst(93,39-93,40)
(or label_3
...
;; def=FStar.Int.fsti(245,23-245,24); use=FStar.Int.fst(92,2-94,43)
(= x_f26957a7e62b271a8736230b1e9c83c1_0
@x4)
)

;; def=prims.fst(420,36-420,97); use=FStar.Int.fst(93,21-93,37)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)

;; def=FStar.Int.fsti(247,17-247,73); use=FStar.Int.fst(93,21-93,37)
(= (FStar.Seq.Base.index Prims.bool
(FStar.Int.to_vec x_f26957a7e62b271a8736230b1e9c83c1_0
(FStar.Int.one x_f26957a7e62b271a8736230b1e9c83c1_0))
x_a6ca6afaf28feca12f50f23fc064a6db_2)
(FStar.Seq.Base.index Prims.bool
(FStar.BitVector.elem_vec x_f26957a7e62b271a8736230b1e9c83c1_0
(BoxInt (- (BoxInt_proj_0 x_f26957a7e62b271a8736230b1e9c83c1_0)
...
;; def=prims.fst(420,83-420,96); use=FStar.Int.fst(93,21-93,37)
(Valid 
;; def=prims.fst(420,83-420,96); use=FStar.Int.fst(93,21-93,37)
(ApplyTT @x3
@x5)
...
;; def=FStar.Int.fst(93,10-94,43); use=FStar.Int.fst(93,10-94,43)
(= (Prims.op_Equality Prims.int
x_afc09461858c30ac5d755a25fcc944b2_1
(BoxInt 0))
@x4)
...
;; def=prims.fst(438,77-438,89); use=FStar.Int.fst(92,2-94,43)
(and 
;; def=prims.fst(662,18-662,23); use=FStar.Int.fst(94,26-94,33)
(or label_4
...
;; def=prims.fst(335,2-335,58); use=FStar.Int.fst(92,2-94,43)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.pos)

;; def=prims.fst(335,26-335,41); use=FStar.Int.fst(92,2-94,43)
(= @x5
(BoxInt (- (BoxInt_proj_0 x_f26957a7e62b271a8736230b1e9c83c1_0)
1)))
)
...
;; def=prims.fst(438,77-438,89); use=FStar.Int.fst(92,2-94,43)
(and 
;; def=prims.fst(659,18-659,24); use=FStar.Int.fst(94,34-94,41)
(or label_5
...
;; def=FStar.Int.fsti(250,39-250,46); use=FStar.Int.fst(94,34-94,41)
(or label_6
...
;; def=prims.fst(335,26-335,41); use=FStar.Int.fst(92,2-94,43)
(= @x6
(BoxInt (- (BoxInt_proj_0 x_afc09461858c30ac5d755a25fcc944b2_1)
1)))
)

;; def=prims.fst(438,77-438,89); use=FStar.Int.fst(92,2-94,43)
(and (implies 
;; def=FStar.Int.fsti(250,57-250,62); use=FStar.Int.fst(94,42-94,43)
(< (BoxInt_proj_0 x_a6ca6afaf28feca12f50f23fc064a6db_2)
(BoxInt_proj_0 x_f26957a7e62b271a8736230b1e9c83c1_0))


;; def=FStar.Int.fst(91,27-94,43); use=FStar.Int.fst(94,42-94,43)
(and 
;; def=FStar.Int.fsti(250,57-250,62); use=FStar.Int.fst(94,42-94,43)
(or label_7
...
;; def=FStar.Int.fst(92,2-94,43); use=FStar.Int.fst(94,42-94,43)
(Valid 
;; def=FStar.Int.fst(92,2-94,43); use=FStar.Int.fst(94,42-94,43)
(Prims.precedes Prims.pos
Prims.pos
(BoxInt (- (BoxInt_proj_0 x_f26957a7e62b271a8736230b1e9c83c1_0)
1))
x_f26957a7e62b271a8736230b1e9c83c1_0)
...
;; def=FStar.Int.fst(91,27-94,43); use=FStar.Int.fst(94,42-94,43)
(and 
;; def=FStar.Int.fst(91,27-91,28); use=FStar.Int.fst(94,42-94,43)
(Valid 
;; def=FStar.Int.fst(91,27-91,28); use=FStar.Int.fst(94,42-94,43)
(Prims.op_Equals_Equals_Equals Prims.pos
Prims.pos
(BoxInt (- (BoxInt_proj_0 x_f26957a7e62b271a8736230b1e9c83c1_0)
1))
x_f26957a7e62b271a8736230b1e9c83c1_0)
...
;; def=FStar.Int.fst(91,29-94,43); use=FStar.Int.fst(94,42-94,43)
(or 
;; def=FStar.Int.fst(92,2-94,43); use=FStar.Int.fst(94,42-94,43)
(Valid 
;; def=FStar.Int.fst(92,2-94,43); use=FStar.Int.fst(94,42-94,43)
...
;; def=FStar.Int.fst(91,29-94,43); use=FStar.Int.fst(94,42-94,43)
(and 
;; def=FStar.Int.fst(91,29-91,30); use=FStar.Int.fst(94,42-94,43)
(Valid 
;; def=FStar.Int.fst(91,29-91,30); use=FStar.Int.fst(94,42-94,43)
...
;; def=FStar.Int.fsti(250,51-250,52); use=FStar.Int.fst(92,2-94,43)
(= x_a6ca6afaf28feca12f50f23fc064a6db_2
@x7)
)

;; def=prims.fst(420,36-420,97); use=FStar.Int.fst(94,7-94,24)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
Prims.unit)

;; def=FStar.Int.fsti(252,17-252,83); use=FStar.Int.fst(94,7-94,24)
(= (FStar.Seq.Base.index Prims.bool
(FStar.Int.to_vec (BoxInt (- (BoxInt_proj_0 x_f26957a7e62b271a8736230b1e9c83c1_0)
1))
(FStar.Int.pow2_n (BoxInt (- (BoxInt_proj_0 x_f26957a7e62b271a8736230b1e9c83c1_0)
1))
(BoxInt (- (BoxInt_proj_0 x_afc09461858c30ac5d755a25fcc944b2_1)
1))))
x_a6ca6afaf28feca12f50f23fc064a6db_2)
(FStar.Seq.Base.index Prims.bool
(FStar.BitVector.elem_vec (BoxInt (- (BoxInt_proj_0 x_f26957a7e62b271a8736230b1e9c83c1_0)
1))
(BoxInt (- (- (- (BoxInt_proj_0 x_f26957a7e62b271a8736230b1e9c83c1_0)
1)
(- (BoxInt_proj_0 x_afc09461858c30ac5d755a25fcc944b2_1)
...
;; def=prims.fst(420,83-420,96); use=FStar.Int.fst(94,7-94,24)
(Valid 
;; def=prims.fst(420,83-420,96); use=FStar.Int.fst(94,7-94,24)
(ApplyTT @x3
@x8)
