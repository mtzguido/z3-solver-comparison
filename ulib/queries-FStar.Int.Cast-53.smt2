...
; UNSAT CORE: @MaxFuel_assumption, @MaxIFuel_assumption, @fuel_correspondence_Prims.pow2.fuel_instrumented, @fuel_irrelevance_Prims.pow2.fuel_instrumented, @query, b2t_def, equation_FStar.Int.fits, equation_FStar.Int.max_int, equation_FStar.Int.min_int, equation_FStar.Int.size, equation_FStar.UInt.fits, equation_FStar.UInt.max_int, equation_FStar.UInt.min_int, equation_FStar.UInt.size, equation_Prims.nat, equation_Prims.pos, equation_with_fuel_Prims.pow2.fuel_instrumented, int_typing, lemma_FStar.UInt.pow2_values, primitive_Prims.op_AmpAmp, primitive_Prims.op_LessThanOrEqual, primitive_Prims.op_Minus, primitive_Prims.op_Multiply, primitive_Prims.op_Subtraction, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_774ba3f728d91ead8ef40be66c9802e5, token_correspondence_Prims.pow2.fuel_instrumented, typing_Prims.pow2

;;; End module Prims (655 decls; total size 39333)
...
;;; End module FStar.Pervasives.Native (1325 decls; total size 133322)
...
;;; End interface FStar.Pervasives (1419 decls; total size 84612)
...
;;; End interface FStar.Classical (203 decls; total size 15078)
...
;;; End module FStar.StrongExcludedMiddle (10 decls; total size 1561)
...
;;; End interface FStar.Classical.Sugar (136 decls; total size 7630)
...
;;; End module FStar.List.Tot.Base (675 decls; total size 88304)
...
;;; End module FStar.List.Tot.Properties (527 decls; total size 52340)
...
;;; End module FStar.List.Tot (3 decls; total size 1033)
...
;;; End interface FStar.Seq.Base (261 decls; total size 17940)
...
;;; End interface FStar.Seq.Properties (842 decls; total size 76641)
...
;;; End module FStar.Seq (3 decls; total size 1023)
...
;;; End interface FStar.Sealed (17 decls; total size 1817)
...
;;; End interface FStar.Range (22 decls; total size 2155)
...
;;; End module FStar.Preorder (56 decls; total size 3375)
...
;;; End interface FStar.Calc (50 decls; total size 3953)
...
;;; End module FStar.Mul (8 decls; total size 1194)
...
;;; End module FStar.Math.Lib (158 decls; total size 13667)
...
;;; End module FStar.Math.Lemmas (616 decls; total size 52918)
...
;;; End module FStar.BitVector (154 decls; total size 16264)
...
;;; End interface FStar.UInt (716 decls; total size 53622)
...
;;; End interface FStar.Int (560 decls; total size 34183)
...
;;; End interface FStar.UInt32 (390 decls; total size 18764)
...
;;; End interface FStar.Int64 (292 decls; total size 13789)
...
;;; End interface FStar.Int32 (292 decls; total size 13789)
...
;;; End interface FStar.Int16 (292 decls; total size 13789)
...
;;; End interface FStar.Int8 (292 decls; total size 13558)
...
;;; End interface FStar.UInt64 (390 decls; total size 18764)
...
;;; End interface FStar.UInt16 (390 decls; total size 18764)
...
;;; End interface FStar.UInt8 (393 decls; total size 18576)
...
; encoding sigelt int16_to_int32
...
; encoding sigelt int32_to_int64
...
; encoding sigelt int32_to_int16
...
; encoding sigelt int64_to_int32
...
; encoding sigelt int64_to_int16
...
; encoding sigelt uint8_to_int64
...
; encoding sigelt uint8_to_int32
...
; encoding sigelt uint8_to_int16


; <Skipped FStar.Int.Cast.uint8_to_int16/>


; Starting query at FStar.Int.Cast.fst(126,23-126,44)
...
; Encoding query formula : forall (x: FStar.UInt8.t).
;   (*could not prove post-condition*)
;   (FStar.UInt.size (FStar.UInt8.v x) 8 ==> FStar.Int.size (FStar.UInt8.v x) 16) /\
;   (forall (return_val: FStar.Int.int_t 16).
;       return_val == FStar.UInt8.v x ==>
;       (forall (pure_result: FStar.Int16.t).
;           FStar.Int16.v pure_result = FStar.UInt8.v x ==>
;           FStar.Int16.int_to_t (FStar.UInt8.v x) == pure_result ==>
;           FStar.Int16.v (FStar.Int16.int_to_t (FStar.UInt8.v x)) = FStar.UInt8.v x))
...
;; def=prims.fst(438,77-438,89); use=FStar.Int.Cast.fst(126,23-126,44)
(and (implies 
;; def=FStar.UInt.fsti(53,28-53,36); use=FStar.Int.Cast.fst(126,36-126,44)
(Valid 
;; def=FStar.UInt.fsti(53,28-53,36); use=FStar.Int.Cast.fst(126,36-126,44)
(FStar.UInt.size (FStar.UInt8.v @x0)
(BoxInt 8))
)


;; def=FStar.Int.fsti(48,27-48,35); use=FStar.Int.Cast.fst(126,36-126,44)
(or label_1

;; def=FStar.Int.fsti(48,27-48,35); use=FStar.Int.Cast.fst(126,36-126,44)
(Valid 
;; def=FStar.Int.fsti(48,27-48,35); use=FStar.Int.Cast.fst(126,36-126,44)
(FStar.Int.size (FStar.UInt8.v @x0)
(BoxInt 16))
)
)
)

;; def=prims.fst(335,2-335,58); use=FStar.Int.Cast.fst(126,23-126,44)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(FStar.Int.int_t (BoxInt 16)))

;; def=prims.fst(335,26-335,41); use=FStar.Int.Cast.fst(126,23-126,44)
(= @x1
(FStar.UInt8.v @x0))
)

;; def=prims.fst(420,36-420,97); use=FStar.Int.Cast.fst(126,27-126,35)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
(FStar.Int16.t Dummy_value))

;; def=FStar.Int16.fsti(36,21-36,28); use=FStar.Int.Cast.fst(126,27-126,35)
(= (FStar.Int16.v @x2)
(FStar.UInt8.v @x0))


;; def=FStar.Int.Cast.fst(125,34-126,44); use=FStar.Int.Cast.fst(126,23-126,44)
(= (FStar.Int16.int_to_t (FStar.UInt8.v @x0))
@x2)
)

;; def=FStar.Int.Cast.fst(125,43-125,59); use=FStar.Int.Cast.fst(126,23-126,44)
(or label_2

;; def=FStar.Int.Cast.fst(125,43-125,59); use=FStar.Int.Cast.fst(126,23-126,44)
(= (FStar.Int16.v (FStar.Int16.int_to_t (FStar.UInt8.v @x0)))
(FStar.UInt8.v @x0))
)
)
