...
(assert (! 
;; def=prims.fst(561,4-561,15); use=prims.fst(561,4-561,15)
(forall ((@x0 Term) (@x1 Term))
...
(assert (! 
;; def=prims.fst(682,4-682,15); use=prims.fst(682,4-682,15)
(forall ((@x0 Term) (@x1 Term))
...
;;; End module FStar.Pervasives.Native (1325 decls; total size 133653)
...
;;; End interface FStar.Pervasives (1419 decls; total size 84943)
...
;;; End interface FStar.Classical (203 decls; total size 15409)
...
;;; End module FStar.StrongExcludedMiddle (10 decls; total size 1892)
...
;;; End interface FStar.Classical.Sugar (136 decls; total size 7961)
...
;;; End module FStar.List.Tot.Base (675 decls; total size 88635)
...
;;; End module FStar.List.Tot.Properties (527 decls; total size 52671)
...
;;; End module FStar.List.Tot (3 decls; total size 1364)
...
(assert (! 
;; def=FStar.Seq.Base.fsti(28,34-28,53); use=FStar.Seq.Base.fsti(28,34-28,53)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
...
;; def=FStar.Seq.Base.fsti(28,40-28,52); use=FStar.Seq.Base.fsti(28,40-28,52)
(< (BoxInt_proj_0 @x1)
...
Prims.nat)
(HasType @x2
(Tm_arrow_44bb45ed5c2534b346e0f58ea5033251 @x0
@x1)))

;; def=FStar.Seq.Base.fsti(68,11-68,41); use=FStar.Seq.Base.fsti(68,11-68,41)
(= (FStar.Seq.Base.length @x0
(FStar.Seq.Base.init @x0
@x1
@x2))
@x1)
)
...
;; def=FStar.Seq.Base.fsti(146,16-146,37); use=FStar.Seq.Base.fsti(146,16-146,37)
(= (FStar.Seq.Base.length @x0
@x1)
(FStar.Seq.Base.length @x0
@x2))
...
;; def=FStar.Seq.Base.fsti(147,18-147,114); use=FStar.Seq.Base.fsti(147,18-147,114)
(forall ((@x3 Term))
 (! (implies (HasType @x3
(Tm_refine_d83f8da8ef6c1cb9f71d1465c1bb1c55 @x0
@x1))

;; def=FStar.Seq.Base.fsti(147,87-147,113); use=FStar.Seq.Base.fsti(147,87-147,113)
...
;; def=FStar.Seq.Base.fsti(148,14-148,27); use=FStar.Seq.Base.fsti(148,14-148,27)
(Valid 
;; def=FStar.Seq.Base.fsti(148,14-148,27); use=FStar.Seq.Base.fsti(148,14-148,27)
...
;; def=FStar.Seq.Base.fsti(187,20-187,27); use=FStar.Seq.Base.fsti(187,20-187,27)
(< (BoxInt_proj_0 @x3)
(BoxInt_proj_0 @x1))
)

;; def=FStar.Seq.Base.fsti(188,13-188,56); use=FStar.Seq.Base.fsti(188,13-188,56)
(= (FStar.Seq.Base.index @x0
(FStar.Seq.Base.init @x0
@x1
@x2)
...
;;; End interface FStar.Seq.Base (265 decls; total size 21752)

;;; Start module FStar.IntegerIntervals

; Externals for module FStar.IntegerIntervals


; <Start encoding FStar.IntegerIntervals.less_than>

(declare-fun FStar.IntegerIntervals.less_than (Term) Term)
;;;;;;;;;;;;;;;;k: Prims.int -> Type
(declare-fun Tm_arrow_fce5e26d6599fbb4e26956c05e4721d2 () Term)
(declare-fun FStar.IntegerIntervals.less_than@tok () Term)
(declare-fun Tm_refine_22e66b3cc5a2a795d66d00b6de2b1e50 (Term) Term)

; </end encoding FStar.IntegerIntervals.less_than>


; <Start encoding FStar.IntegerIntervals.greater_than>

(declare-fun FStar.IntegerIntervals.greater_than (Term) Term)

(declare-fun FStar.IntegerIntervals.greater_than@tok () Term)
(declare-fun Tm_refine_25948cf2cb84e8edfffe30eaf3d63408 (Term) Term)

; </end encoding FStar.IntegerIntervals.greater_than>


; <Start encoding FStar.IntegerIntervals.not_less_than>

(declare-fun FStar.IntegerIntervals.not_less_than (Term) Term)

(declare-fun FStar.IntegerIntervals.not_less_than@tok () Term)

; </end encoding FStar.IntegerIntervals.not_less_than>


; <Start encoding FStar.IntegerIntervals.not_greater_than>

(declare-fun FStar.IntegerIntervals.not_greater_than (Term) Term)

(declare-fun FStar.IntegerIntervals.not_greater_than@tok () Term)

; </end encoding FStar.IntegerIntervals.not_greater_than>


; <Start encoding FStar.IntegerIntervals.coerce_to_less_than>

(declare-fun FStar.IntegerIntervals.coerce_to_less_than (Term Term) Term)
;;;;;;;;;;;;;;;;x: FStar.IntegerIntervals.not_greater_than n -> FStar.IntegerIntervals.less_than (n + 1)
(declare-fun Tm_arrow_95c0f84be1b6f3a094aeaa739846d346 () Term)
(declare-fun FStar.IntegerIntervals.coerce_to_less_than@tok () Term)

; </end encoding FStar.IntegerIntervals.coerce_to_less_than>


; <Start encoding FStar.IntegerIntervals.coerce_to_not_less_than>

(declare-fun FStar.IntegerIntervals.coerce_to_not_less_than (Term Term) Term)
;;;;;;;;;;;;;;;;x: FStar.IntegerIntervals.greater_than n -> FStar.IntegerIntervals.not_less_than (n + 1)
(declare-fun Tm_arrow_410b3aa5d7ccb5bbb19aafe4eb575baa () Term)
(declare-fun FStar.IntegerIntervals.coerce_to_not_less_than@tok () Term)

; </end encoding FStar.IntegerIntervals.coerce_to_not_less_than>


; <Start encoding FStar.IntegerIntervals.interval_condition>

(declare-fun FStar.IntegerIntervals.interval_condition (Term Term Term) Term)
;;;;;;;;;;;;;;;;x: Prims.int -> y: Prims.int -> t: Prims.int -> Prims.bool
(declare-fun Tm_arrow_109cb0d9465900e77361a7709fd60f59 () Term)
(declare-fun FStar.IntegerIntervals.interval_condition@tok () Term)
;;;;;;;;;;;;;;;;free var typing
...
(HasType @x2
Prims.int))
(HasType (FStar.IntegerIntervals.interval_condition @x0
@x1
@x2)
Prims.bool))
 

:pattern ((FStar.IntegerIntervals.interval_condition @x0
@x1
@x2))
...
;; def=FStar.IntegerIntervals.fst(33,4-33,22); use=FStar.IntegerIntervals.fst(33,4-33,22)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (FStar.IntegerIntervals.interval_condition @x0
@x1
@x2)
(Prims.op_AmpAmp (Prims.op_LessThanOrEqual @x0
@x2)
...
; </end encoding FStar.IntegerIntervals.interval_condition>


; <Start encoding FStar.IntegerIntervals.interval_type>

(declare-fun FStar.IntegerIntervals.interval_type (Term Term) Term)
;;;;;;;;;;;;;;;;x: Prims.int -> y: Prims.int -> Type
(declare-fun Tm_arrow_4ac6f7d06c7c49777e40abfcba22b5d0 () Term)
(declare-fun FStar.IntegerIntervals.interval_type@tok () Term)
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_fcf1a3596fffd49dd2e91f2678358f19 @x2
@x3))
(and (HasTypeFuel @u0
@x1
Prims.int)
...
(BoxBool_proj_0 (FStar.IntegerIntervals.interval_condition @x2
@x3
@x1))
))
...
(declare-fun Tm_refine_3c4167b507ffe04135b47025f765c8a4 (Term Term) Term)

; </end encoding FStar.IntegerIntervals.interval_type>


; <Start encoding FStar.IntegerIntervals.interval>

(declare-fun FStar.IntegerIntervals.interval (Term Term) Term)
;;;;;;;;;;;;;;;;x: Prims.int -> y: Prims.int -> FStar.IntegerIntervals.interval_type x y
(declare-fun Tm_arrow_5f73bee1456faf47e3b59892b1bd9217 () Term)
(declare-fun FStar.IntegerIntervals.interval@tok () Term)
...
(forall ((@x0 Term) (@x1 Term))
 (! (= (FStar.IntegerIntervals.interval @x0
@x1)
(Tm_refine_fcf1a3596fffd49dd2e91f2678358f19 @x0
@x1))
 

:pattern ((FStar.IntegerIntervals.interval @x0
@x1))
:qid equation_FStar.IntegerIntervals.interval))

:named equation_FStar.IntegerIntervals.interval))

; </end encoding FStar.IntegerIntervals.interval>


; <Start encoding FStar.IntegerIntervals.efrom_eto>

(declare-fun FStar.IntegerIntervals.efrom_eto (Term Term) Term)
;;;;;;;;;;;;;;;;x: Prims.int -> y: Prims.int -> FStar.IntegerIntervals.interval_type (x + 1) y
(declare-fun Tm_arrow_543f5aeb154d4267b77a5626cd1b83b3 () Term)
(declare-fun FStar.IntegerIntervals.efrom_eto@tok () Term)

; </end encoding FStar.IntegerIntervals.efrom_eto>


; <Start encoding FStar.IntegerIntervals.efrom_ito>

(declare-fun FStar.IntegerIntervals.efrom_ito (Term Term) Term)
;;;;;;;;;;;;;;;;x: Prims.int -> y: Prims.int -> FStar.IntegerIntervals.interval_type (x + 1) (y + 1)
(declare-fun Tm_arrow_bb6b629d89e588782cae1537e1cec2a5 () Term)
(declare-fun FStar.IntegerIntervals.efrom_ito@tok () Term)

; </end encoding FStar.IntegerIntervals.efrom_ito>


; <Start encoding FStar.IntegerIntervals.ifrom_eto>

(declare-fun FStar.IntegerIntervals.ifrom_eto (Term Term) Term)

(declare-fun FStar.IntegerIntervals.ifrom_eto@tok () Term)

; </end encoding FStar.IntegerIntervals.ifrom_eto>


; <Start encoding FStar.IntegerIntervals.ifrom_ito>

(declare-fun FStar.IntegerIntervals.ifrom_ito (Term Term) Term)
;;;;;;;;;;;;;;;;x: Prims.int -> y: Prims.int -> FStar.IntegerIntervals.interval_type x (y + 1)
(declare-fun Tm_arrow_501a0be3e6f6041c64250399f34eb19c () Term)
(declare-fun FStar.IntegerIntervals.ifrom_ito@tok () Term)

; </end encoding FStar.IntegerIntervals.ifrom_ito>


; <Start encoding FStar.IntegerIntervals.under>

(declare-fun FStar.IntegerIntervals.under (Term) Term)
;;;;;;;;;;;;;;;;k: Prims.nat -> FStar.IntegerIntervals.interval_type 0 k
(declare-fun Tm_arrow_4e1d828026ae0c3af5d5aa22b09df08b () Term)
(declare-fun FStar.IntegerIntervals.under@tok () Term)
...
(FStar.IntegerIntervals.interval (BoxInt 0)
@x0))
...
; </end encoding FStar.IntegerIntervals.under>


; <Start encoding FStar.IntegerIntervals.closed_interval_lemma>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.IntegerIntervals.closed_interval_lemma (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.IntegerIntervals.closed_interval_lemma@tok () Term)

; </end encoding FStar.IntegerIntervals.closed_interval_lemma>


; <Start encoding FStar.IntegerIntervals.interval_size>

(declare-fun FStar.IntegerIntervals.interval_size (Term Term Term) Term)
;;;;;;;;;;;;;;;;interval: FStar.IntegerIntervals.interval_type x y -> Prims.nat
(declare-fun Tm_arrow_5bb4940493542c8a5aa9729869aea4cc () Term)
(declare-fun FStar.IntegerIntervals.interval_size@tok () Term)

; </end encoding FStar.IntegerIntervals.interval_size>


; <Start encoding FStar.IntegerIntervals.counter_for>

(declare-fun FStar.IntegerIntervals.counter_for (Term Term Term) Term)
;;;;;;;;;;;;;;;;interval: FStar.IntegerIntervals.interval_type x y   -> FStar.IntegerIntervals.interval_type 0 (FStar.IntegerIntervals.interval_size interval)
(declare-fun Tm_arrow_570ccd6adf6c70213e6953cad6ed4c4e () Term)
(declare-fun FStar.IntegerIntervals.counter_for@tok () Term)

; </end encoding FStar.IntegerIntervals.counter_for>


; <Start encoding FStar.IntegerIntervals.closed_interval_size>

(declare-fun FStar.IntegerIntervals.closed_interval_size (Term Term) Term)
;;;;;;;;;;;;;;;;x: Prims.int -> y: Prims.int -> Prims.nat
(declare-fun Tm_arrow_1b65c43a249fe479c371e0a9f398a794 () Term)
(declare-fun FStar.IntegerIntervals.closed_interval_size@tok () Term)

; </end encoding FStar.IntegerIntervals.closed_interval_size>


; <Start encoding FStar.IntegerIntervals.uu___41>

(declare-fun FStar.IntegerIntervals.uu___41 (Dummy_sort) Term)

; </end encoding FStar.IntegerIntervals.uu___41>


; <Start encoding FStar.IntegerIntervals.uu___42>

(declare-fun FStar.IntegerIntervals.uu___42 (Dummy_sort) Term)

; </end encoding FStar.IntegerIntervals.uu___42>


; <Start encoding FStar.IntegerIntervals.uu___43>

(declare-fun FStar.IntegerIntervals.uu___43 (Dummy_sort) Term)

; </end encoding FStar.IntegerIntervals.uu___43>


; <Start encoding FStar.IntegerIntervals.counter_bounds_lemma>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.IntegerIntervals.counter_bounds_lemma (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.IntegerIntervals.counter_bounds_lemma@tok () Term)

; </end encoding FStar.IntegerIntervals.counter_bounds_lemma>


; <Start encoding FStar.IntegerIntervals.indices_seq>

(declare-fun FStar.IntegerIntervals.indices_seq (Term) Term)
(declare-fun Tm_refine_f1b7d0ec3cc2a803d15c63af18d3eb79 (Term) Term)
...
(declare-fun Tm_arrow_da3f5a27f867fa76e44a7da04efea326 () Term)
(declare-fun FStar.IntegerIntervals.indices_seq@tok () Term)

;;;;;;;;;;;;;;;;x: FStar.IntegerIntervals.under n -> FStar.IntegerIntervals.under n
...
; </end encoding FStar.IntegerIntervals.indices_seq>


; End Externals for module FStar.IntegerIntervals


; UNSAT CORE: @MaxIFuel_assumption, @query, bool_inversion, equation_FStar.IntegerIntervals.interval, equation_FStar.IntegerIntervals.interval_condition, equation_FStar.IntegerIntervals.under, equation_FStar.Matrix.get_i, equation_FStar.Matrix.get_ij, equation_FStar.Matrix.get_j, equation_FStar.Matrix.matrix_seq, equation_Prims.nat, equation_Prims.pos, int_inversion, int_typing, lemma_FStar.Seq.Base.init_index_, lemma_FStar.Seq.Base.lemma_eq_intro, lemma_FStar.Seq.Base.lemma_init_len, primitive_Prims.op_Addition, primitive_Prims.op_AmpAmp, primitive_Prims.op_Division, primitive_Prims.op_LessThan, primitive_Prims.op_LessThanOrEqual, primitive_Prims.op_Modulus, primitive_Prims.op_Multiply, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_0b23d6c7d0419bb206296345badf754b, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_774ba3f728d91ead8ef40be66c9802e5, refinement_interpretation_Tm_refine_d83f8da8ef6c1cb9f71d1465c1bb1c55, refinement_interpretation_Tm_refine_fcf1a3596fffd49dd2e91f2678358f19, typing_FStar.IntegerIntervals.interval_condition, typing_FStar.Matrix.get_i, typing_FStar.Matrix.get_ij, typing_FStar.Matrix.get_j, typing_FStar.Matrix.matrix_seq

;;; End module FStar.IntegerIntervals (124 decls; total size 13009)
...
;;; End interface FStar.Seq.Properties (842 decls; total size 76972)
...
;;; End module FStar.Mul (8 decls; total size 1525)

;;; Start module FStar.Algebra.CommMonoid.Equiv

; Externals for module FStar.Algebra.CommMonoid.Equiv
...
;;;;;;;;;;;;;;;;eq: (_: a -> _: a -> Type) ->     reflexivity: (x: a -> FStar.Pervasives.Lemma (ensures eq x x)) ->     symmetry: (x: a -> y: a -> FStar.Pervasives.Lemma (requires eq x y) (ensures eq y x)) ->     transitivity:       (x: a -> y: a -> z: a -> FStar.Pervasives.Lemma (requires eq x y /\ eq y z) (ensures eq x z))   -> FStar.Algebra.CommMonoid.Equiv.equiv a
...
;;;;;;;;;;;;;;;;projectee: FStar.Algebra.CommMonoid.Equiv.equiv a -> Prims.bool
...
;;;;;;;;;;;;;;;;projectee: FStar.Algebra.CommMonoid.Equiv.equiv a -> _: a -> _: a -> Type
...
;;;;;;;;;;;;;;;;projectee: FStar.Algebra.CommMonoid.Equiv.equiv a -> x: a   -> FStar.Pervasives.Lemma (ensures EQ?.eq projectee x x)
...
;;;;;;;;;;;;;;;;projectee: FStar.Algebra.CommMonoid.Equiv.equiv a -> x: a -> y: a   -> FStar.Pervasives.Lemma (requires EQ?.eq projectee x y) (ensures EQ?.eq projectee y x)
...
;;;;;;;;;;;;;;;;projectee: FStar.Algebra.CommMonoid.Equiv.equiv a -> x: a -> y: a -> z: a   -> FStar.Pervasives.Lemma (requires EQ?.eq projectee x y /\ EQ?.eq projectee y z)       (ensures EQ?.eq projectee x z)
...
;;;;;;;;;;;;;;;;unit: a ->     mult: (_: a -> _: a -> a) ->     identity: (x: a -> FStar.Pervasives.Lemma (ensures EQ?.eq eq (mult unit x) x)) ->     associativity:       (x: a -> y: a -> z: a           -> FStar.Pervasives.Lemma (ensures EQ?.eq eq (mult (mult x y) z) (mult x (mult y z)))) ->     commutativity:       (x: a -> y: a -> FStar.Pervasives.Lemma (ensures EQ?.eq eq (mult x y) (mult y x))) ->     congruence:       (x: a -> y: a -> z: a -> w: a           -> FStar.Pervasives.Lemma (requires EQ?.eq eq x z /\ EQ?.eq eq y w)               (ensures EQ?.eq eq (mult x y) (mult z w)))   -> FStar.Algebra.CommMonoid.Equiv.cm a eq
...
;;;;;;;;;;;;;;;;projectee: FStar.Algebra.CommMonoid.Equiv.cm a eq -> Prims.bool
...
;;;;;;;;;;;;;;;;projectee: FStar.Algebra.CommMonoid.Equiv.cm a eq -> a
...
;;;;;;;;;;;;;;;;projectee: FStar.Algebra.CommMonoid.Equiv.cm a eq -> _: a -> _: a -> a
...
;;;;;;;;;;;;;;;;projectee: FStar.Algebra.CommMonoid.Equiv.cm a eq -> x: a   -> FStar.Pervasives.Lemma (ensures EQ?.eq eq (CM?.mult projectee (CM?.unit projectee) x) x)
...
;;;;;;;;;;;;;;;;projectee: FStar.Algebra.CommMonoid.Equiv.cm a eq -> x: a -> y: a -> z: a   -> FStar.Pervasives.Lemma     (ensures       EQ?.eq eq         (CM?.mult projectee (CM?.mult projectee x y) z)         (CM?.mult projectee x (CM?.mult projectee y z)))
...
;;;;;;;;;;;;;;;;projectee: FStar.Algebra.CommMonoid.Equiv.cm a eq -> x: a -> y: a   -> FStar.Pervasives.Lemma (ensures EQ?.eq eq (CM?.mult projectee x y) (CM?.mult projectee y x))
...
;;;;;;;;;;;;;;;;projectee: FStar.Algebra.CommMonoid.Equiv.cm a eq -> x: a -> y: a -> z: a -> w: a   -> FStar.Pervasives.Lemma (requires EQ?.eq eq x z /\ EQ?.eq eq y w)       (ensures EQ?.eq eq (CM?.mult projectee x y) (CM?.mult projectee z w))
...
; <Start encoding FStar.Algebra.CommMonoid.Equiv.int_multiply_cm>

(declare-fun FStar.Algebra.CommMonoid.Equiv.int_multiply_cm (Dummy_sort) Term)
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name FStar.Algebra.CommMonoid.Equiv.int_multiply_cm; Namespace FStar.Algebra.CommMonoid.Equiv
(assert (! (Valid (ApplyTT __uu__PartialApp
Prims.op_Multiply@tok))
:named @kick_partial_app_82a73bff7b4c024eca5fe825f324a9b4))





; </end encoding FStar.Algebra.CommMonoid.Equiv.int_multiply_cm>


; End Externals for module FStar.Algebra.CommMonoid.Equiv


; UNSAT CORE: @MaxIFuel_assumption, @query, bool_inversion, equation_FStar.IntegerIntervals.interval, equation_FStar.IntegerIntervals.interval_condition, equation_FStar.IntegerIntervals.under, equation_FStar.Matrix.get_i, equation_FStar.Matrix.get_ij, equation_FStar.Matrix.get_j, equation_FStar.Matrix.matrix_seq, equation_Prims.nat, equation_Prims.pos, int_inversion, int_typing, lemma_FStar.Seq.Base.init_index_, lemma_FStar.Seq.Base.lemma_eq_intro, lemma_FStar.Seq.Base.lemma_init_len, primitive_Prims.op_Addition, primitive_Prims.op_AmpAmp, primitive_Prims.op_Division, primitive_Prims.op_LessThan, primitive_Prims.op_LessThanOrEqual, primitive_Prims.op_Modulus, primitive_Prims.op_Multiply, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_0b23d6c7d0419bb206296345badf754b, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_774ba3f728d91ead8ef40be66c9802e5, refinement_interpretation_Tm_refine_d83f8da8ef6c1cb9f71d1465c1bb1c55, refinement_interpretation_Tm_refine_fcf1a3596fffd49dd2e91f2678358f19, typing_FStar.IntegerIntervals.interval_condition, typing_FStar.Matrix.get_i, typing_FStar.Matrix.get_ij, typing_FStar.Matrix.get_j, typing_FStar.Matrix.matrix_seq

;;; End module FStar.Algebra.CommMonoid.Equiv (343 decls; total size 22664)

;;; Start interface FStar.Seq.Equiv

; Externals for interface FStar.Seq.Equiv


; <Start encoding FStar.Seq.Equiv.eq_of_seq>

(declare-fun FStar.Seq.Equiv.eq_of_seq (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;eq: FStar.Algebra.CommMonoid.Equiv.equiv c -> s1: FStar.Seq.Base.seq c -> s2: FStar.Seq.Base.seq c   -> Prims.prop
(declare-fun Tm_arrow_da4607575393801cc4c1b1d1bb1765ea () Term)
(declare-fun FStar.Seq.Equiv.eq_of_seq@tok () Term)

; </end encoding FStar.Seq.Equiv.eq_of_seq>


; <Start encoding FStar.Seq.Equiv.eq_of_seq_element_equality>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Seq.Equiv.eq_of_seq_element_equality (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Seq.Equiv.eq_of_seq_element_equality@tok () Term)

; </end encoding FStar.Seq.Equiv.eq_of_seq_element_equality>


; <Start encoding FStar.Seq.Equiv.eq_of_seq_from_element_equality>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Seq.Equiv.eq_of_seq_from_element_equality (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Seq.Equiv.eq_of_seq_from_element_equality@tok () Term)

; </end encoding FStar.Seq.Equiv.eq_of_seq_from_element_equality>


; <Start encoding FStar.Seq.Equiv.eq_of_seq_condition>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Seq.Equiv.eq_of_seq_condition (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Seq.Equiv.eq_of_seq_condition@tok () Term)

; </end encoding FStar.Seq.Equiv.eq_of_seq_condition>


; <Start encoding FStar.Seq.Equiv.eq_of_seq_reflexivity>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Seq.Equiv.eq_of_seq_reflexivity (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Seq.Equiv.eq_of_seq_reflexivity@tok () Term)

; </end encoding FStar.Seq.Equiv.eq_of_seq_reflexivity>


; <Start encoding FStar.Seq.Equiv.eq_of_seq_symmetry>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Seq.Equiv.eq_of_seq_symmetry (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Seq.Equiv.eq_of_seq_symmetry@tok () Term)

; </end encoding FStar.Seq.Equiv.eq_of_seq_symmetry>


; <Start encoding FStar.Seq.Equiv.eq_of_seq_transitivity>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Seq.Equiv.eq_of_seq_transitivity (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Seq.Equiv.eq_of_seq_transitivity@tok () Term)

; </end encoding FStar.Seq.Equiv.eq_of_seq_transitivity>


; <Start encoding FStar.Seq.Equiv.seq_equiv>

(declare-fun FStar.Seq.Equiv.seq_equiv (Term Term) Term)
;;;;;;;;;;;;;;;;eq: FStar.Algebra.CommMonoid.Equiv.equiv c   -> FStar.Algebra.CommMonoid.Equiv.equiv (FStar.Seq.Base.seq c)
(declare-fun Tm_arrow_0abc49df52f5756ae9b5a5cd5fb29944 () Term)
(declare-fun FStar.Seq.Equiv.seq_equiv@tok () Term)

; </end encoding FStar.Seq.Equiv.seq_equiv>


; <Start encoding FStar.Seq.Equiv.eq_of_seq_unsnoc>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Seq.Equiv.eq_of_seq_unsnoc (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Seq.Equiv.eq_of_seq_unsnoc@tok () Term)

; </end encoding FStar.Seq.Equiv.eq_of_seq_unsnoc>


; End Externals for interface FStar.Seq.Equiv


; UNSAT CORE: @MaxIFuel_assumption, @query, bool_inversion, equation_FStar.IntegerIntervals.interval, equation_FStar.IntegerIntervals.interval_condition, equation_FStar.IntegerIntervals.under, equation_FStar.Matrix.get_i, equation_FStar.Matrix.get_ij, equation_FStar.Matrix.get_j, equation_FStar.Matrix.matrix_seq, equation_Prims.nat, equation_Prims.pos, int_inversion, int_typing, lemma_FStar.Seq.Base.init_index_, lemma_FStar.Seq.Base.lemma_eq_intro, lemma_FStar.Seq.Base.lemma_init_len, primitive_Prims.op_Addition, primitive_Prims.op_AmpAmp, primitive_Prims.op_Division, primitive_Prims.op_LessThan, primitive_Prims.op_LessThanOrEqual, primitive_Prims.op_Modulus, primitive_Prims.op_Multiply, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_0b23d6c7d0419bb206296345badf754b, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_774ba3f728d91ead8ef40be66c9802e5, refinement_interpretation_Tm_refine_d83f8da8ef6c1cb9f71d1465c1bb1c55, refinement_interpretation_Tm_refine_fcf1a3596fffd49dd2e91f2678358f19, typing_FStar.IntegerIntervals.interval_condition, typing_FStar.Matrix.get_i, typing_FStar.Matrix.get_ij, typing_FStar.Matrix.get_j, typing_FStar.Matrix.matrix_seq

;;; End interface FStar.Seq.Equiv (41 decls; total size 4865)
...
;;; End interface FStar.Sealed (17 decls; total size 2148)
...
;;; End interface FStar.Range (22 decls; total size 2486)
...
;;; End module FStar.Preorder (56 decls; total size 3602)
...
;;; End interface FStar.Calc (50 decls; total size 4284)
...
;;; End module FStar.Math.Lib (158 decls; total size 13998)
...
;;; End module FStar.Math.Lemmas (616 decls; total size 53249)
...
;;; End module FStar.Seq (3 decls; total size 1354)

;;; Start interface FStar.Seq.Permutation

; Externals for interface FStar.Seq.Permutation


; <Start encoding FStar.Seq.Permutation.index_fun>

(declare-fun FStar.Seq.Permutation.index_fun (Term Term) Term)
;;;;;;;;;;;;;;;;s: FStar.Seq.Base.seq a -> Type
(declare-fun Tm_arrow_691144ba92884edf28c1d5759f07464f () Term)
(declare-fun FStar.Seq.Permutation.index_fun@tok () Term)
;;;;;;;;;;;;;;;;_: FStar.IntegerIntervals.under (FStar.Seq.Base.length s)   -> FStar.IntegerIntervals.under (FStar.Seq.Base.length s)
(declare-fun Tm_arrow_0811d3d56ae5f8c9b27d421e998a934e (Term Term) Term)

; </end encoding FStar.Seq.Permutation.index_fun>


; <Start encoding FStar.Seq.Permutation.is_permutation>

(declare-fun FStar.Seq.Permutation.is_permutation (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;s0: FStar.Seq.Base.seq a -> s1: FStar.Seq.Base.seq a -> f: FStar.Seq.Permutation.index_fun s0   -> Prims.prop
(declare-fun Tm_arrow_0b8cf18be74dcdc97a6f02357b625832 () Term)
(declare-fun FStar.Seq.Permutation.is_permutation@tok () Term)

; </end encoding FStar.Seq.Permutation.is_permutation>


; <Start encoding FStar.Seq.Permutation.reveal_is_permutation>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Seq.Permutation.reveal_is_permutation (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Seq.Permutation.reveal_is_permutation@tok () Term)

; </end encoding FStar.Seq.Permutation.reveal_is_permutation>


; <Start encoding FStar.Seq.Permutation.seqperm>

(declare-fun FStar.Seq.Permutation.seqperm (Term Term Term) Term)
;;;;;;;;;;;;;;;;s0: FStar.Seq.Base.seq a -> s1: FStar.Seq.Base.seq a -> Type
(declare-fun Tm_arrow_b075dbd23ff57920b5046920c08834b0 () Term)
(declare-fun FStar.Seq.Permutation.seqperm@tok () Term)
(declare-fun Tm_refine_739ae919a15c5dce278ff1db013aab45 (Term Term Term) Term)

; </end encoding FStar.Seq.Permutation.seqperm>


; <Start encoding FStar.Seq.Permutation.permutation_from_equal_counts>

(declare-fun Tm_refine_ebdc74b366444fd8cad9165e38659e1e (Term Term) Term)
(declare-fun FStar.Seq.Permutation.permutation_from_equal_counts (Term Term Term) Term)

;;;;;;;;;;;;;;;;s0: FStar.Seq.Base.seq a ->     s1:       FStar.Seq.Base.seq a         {forall (x: a). FStar.Seq.Properties.count x s0 == FStar.Seq.Properties.count x s1}   -> FStar.Seq.Permutation.seqperm s0 s1
(declare-fun Tm_arrow_4280f96e85669dfd53300a2ecddb38cb () Term)
(declare-fun FStar.Seq.Permutation.permutation_from_equal_counts@tok () Term)

; </end encoding FStar.Seq.Permutation.permutation_from_equal_counts>


; <Start encoding FStar.Seq.Permutation.foldm_snoc>

(declare-fun FStar.Seq.Permutation.foldm_snoc (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;m: FStar.Algebra.CommMonoid.Equiv.cm a eq -> s: FStar.Seq.Base.seq a -> a
(declare-fun Tm_arrow_bdd09bc73ba47b29551a9c0e2e9a0c2e () Term)
(declare-fun FStar.Seq.Permutation.foldm_snoc@tok () Term)

; </end encoding FStar.Seq.Permutation.foldm_snoc>


; <Start encoding FStar.Seq.Permutation.foldm_snoc_unit_seq>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Seq.Permutation.foldm_snoc_unit_seq (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Seq.Permutation.foldm_snoc_unit_seq@tok () Term)

; </end encoding FStar.Seq.Permutation.foldm_snoc_unit_seq>


; <Start encoding FStar.Seq.Permutation.foldm_snoc_singleton>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Seq.Permutation.foldm_snoc_singleton (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Seq.Permutation.foldm_snoc_singleton@tok () Term)

; </end encoding FStar.Seq.Permutation.foldm_snoc_singleton>


; <Start encoding FStar.Seq.Permutation.foldm_snoc_append>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Seq.Permutation.foldm_snoc_append (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Seq.Permutation.foldm_snoc_append@tok () Term)

; </end encoding FStar.Seq.Permutation.foldm_snoc_append>


; <Start encoding FStar.Seq.Permutation.foldm_snoc_sym>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Seq.Permutation.foldm_snoc_sym (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Seq.Permutation.foldm_snoc_sym@tok () Term)

; </end encoding FStar.Seq.Permutation.foldm_snoc_sym>


; <Start encoding FStar.Seq.Permutation.foldm_snoc_perm>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Seq.Permutation.foldm_snoc_perm (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Seq.Permutation.foldm_snoc_perm@tok () Term)

; </end encoding FStar.Seq.Permutation.foldm_snoc_perm>


; <Start encoding FStar.Seq.Permutation.init_func_from_expr>

;;;;;;;;;;;;;;;;_: FStar.IntegerIntervals.ifrom_ito n0 nk -> c
(declare-fun Tm_arrow_ef77b31984da8a7c57d57134fa0c17e7 (Term Term Term) Term)
(declare-fun FStar.Seq.Permutation.init_func_from_expr (Term Term Term Term Term Term Term) Term)
...
(declare-fun Tm_arrow_e32073ceb5b5ec44c6dde5ece85b1df5 () Term)
(declare-fun FStar.Seq.Permutation.init_func_from_expr@tok () Term)


; </end encoding FStar.Seq.Permutation.init_func_from_expr>


; <Start encoding FStar.Seq.Permutation.func_sum>



(declare-fun FStar.Seq.Permutation.func_sum (Term Term Term Term Term Term) Term)




(declare-fun Tm_refine_c35f694609733148eaf0d00528cf556e (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;cm: FStar.Algebra.CommMonoid.Equiv.cm c eq -> f: (_: a -> c) -> g: (_: a -> c)   -> t: (_: a -> c){forall (x: a). t x == CM?.mult cm (f x) (g x)}
(declare-fun Tm_arrow_656892104503d4959cf8f34915648e37 () Term)
(declare-fun FStar.Seq.Permutation.func_sum@tok () Term)
...
(declare-fun Tm_abs_b3208819a2b01ef4183c0f762a1088fa (Term Term Term Term Term Term) Term)

; </end encoding FStar.Seq.Permutation.func_sum>


; <Start encoding FStar.Seq.Permutation.foldm_snoc_split>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Seq.Permutation.foldm_snoc_split (Term Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Seq.Permutation.foldm_snoc_split@tok () Term)

; </end encoding FStar.Seq.Permutation.foldm_snoc_split>


; <Start encoding FStar.Seq.Permutation.foldm_snoc_equality>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Seq.Permutation.foldm_snoc_equality (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Seq.Permutation.foldm_snoc_equality@tok () Term)

; </end encoding FStar.Seq.Permutation.foldm_snoc_equality>


; <Start encoding FStar.Seq.Permutation.foldm_snoc_split_seq>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Seq.Permutation.foldm_snoc_split_seq (Term Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Seq.Permutation.foldm_snoc_split_seq@tok () Term)

; </end encoding FStar.Seq.Permutation.foldm_snoc_split_seq>


; <Start encoding FStar.Seq.Permutation.foldm_snoc_of_equal_inits>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Seq.Permutation.foldm_snoc_of_equal_inits (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Seq.Permutation.foldm_snoc_of_equal_inits@tok () Term)

; </end encoding FStar.Seq.Permutation.foldm_snoc_of_equal_inits>


; <Start encoding FStar.Seq.Permutation.foldm_snoc_decomposition>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Seq.Permutation.foldm_snoc_decomposition (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Seq.Permutation.foldm_snoc_decomposition@tok () Term)

; </end encoding FStar.Seq.Permutation.foldm_snoc_decomposition>


; End Externals for interface FStar.Seq.Permutation


; UNSAT CORE: @MaxIFuel_assumption, @query, bool_inversion, equation_FStar.IntegerIntervals.interval, equation_FStar.IntegerIntervals.interval_condition, equation_FStar.IntegerIntervals.under, equation_FStar.Matrix.get_i, equation_FStar.Matrix.get_ij, equation_FStar.Matrix.get_j, equation_FStar.Matrix.matrix_seq, equation_Prims.nat, equation_Prims.pos, int_inversion, int_typing, lemma_FStar.Seq.Base.init_index_, lemma_FStar.Seq.Base.lemma_eq_intro, lemma_FStar.Seq.Base.lemma_init_len, primitive_Prims.op_Addition, primitive_Prims.op_AmpAmp, primitive_Prims.op_Division, primitive_Prims.op_LessThan, primitive_Prims.op_LessThanOrEqual, primitive_Prims.op_Modulus, primitive_Prims.op_Multiply, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_0b23d6c7d0419bb206296345badf754b, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_774ba3f728d91ead8ef40be66c9802e5, refinement_interpretation_Tm_refine_d83f8da8ef6c1cb9f71d1465c1bb1c55, refinement_interpretation_Tm_refine_fcf1a3596fffd49dd2e91f2678358f19, typing_FStar.IntegerIntervals.interval_condition, typing_FStar.Matrix.get_i, typing_FStar.Matrix.get_ij, typing_FStar.Matrix.get_j, typing_FStar.Matrix.matrix_seq

;;; End interface FStar.Seq.Permutation (104 decls; total size 9738)

;;; Start interface FStar.Algebra.CommMonoid.Fold

; Externals for interface FStar.Algebra.CommMonoid.Fold


; <Start encoding FStar.Algebra.CommMonoid.Fold.init_func_from_expr>


(declare-fun FStar.Algebra.CommMonoid.Fold.init_func_from_expr (Term Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;_: FStar.IntegerIntervals.counter_for (FStar.IntegerIntervals.ifrom_ito a b) -> c
(declare-fun Tm_arrow_ef6b26184b4381c2e1f4e80e68bc4c6e (Term Term Term) Term)
...
(declare-fun Tm_arrow_ad23fb7862cccec057837643e3b9aea9 () Term)
(declare-fun FStar.Algebra.CommMonoid.Fold.init_func_from_expr@tok () Term)



(declare-fun Tm_abs_aa596cdfe1f87b30697e767d9faf69ab (Term Term Term Term Term) Term)

; </end encoding FStar.Algebra.CommMonoid.Fold.init_func_from_expr>


; <Start encoding FStar.Algebra.CommMonoid.Fold.fold>


(declare-fun FStar.Algebra.CommMonoid.Fold.fold (Term Term Term Term Term Term) Term)

;;;;;;;;;;;;;;;;cm: FStar.Algebra.CommMonoid.Equiv.cm c eq ->     a: Prims.int ->     b: FStar.IntegerIntervals.not_less_than a ->     expr: (_: FStar.IntegerIntervals.ifrom_ito a b -> c)   -> c
(declare-fun Tm_arrow_5a25098ed5fbf15376c806daacc11441 () Term)
(declare-fun FStar.Algebra.CommMonoid.Fold.fold@tok () Term)

; </end encoding FStar.Algebra.CommMonoid.Fold.fold>


; <Start encoding FStar.Algebra.CommMonoid.Fold.fold_equality>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Algebra.CommMonoid.Fold.fold_equality (Term Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Algebra.CommMonoid.Fold.fold_equality@tok () Term)

; </end encoding FStar.Algebra.CommMonoid.Fold.fold_equality>


; <Start encoding FStar.Algebra.CommMonoid.Fold.fold_singleton_lemma>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Algebra.CommMonoid.Fold.fold_singleton_lemma (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Algebra.CommMonoid.Fold.fold_singleton_lemma@tok () Term)

; </end encoding FStar.Algebra.CommMonoid.Fold.fold_singleton_lemma>


; <Start encoding FStar.Algebra.CommMonoid.Fold.fold_snoc_decomposition>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Algebra.CommMonoid.Fold.fold_snoc_decomposition (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Algebra.CommMonoid.Fold.fold_snoc_decomposition@tok () Term)

; </end encoding FStar.Algebra.CommMonoid.Fold.fold_snoc_decomposition>


; <Start encoding FStar.Algebra.CommMonoid.Fold.fold_equals_seq_foldm>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Algebra.CommMonoid.Fold.fold_equals_seq_foldm (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Algebra.CommMonoid.Fold.fold_equals_seq_foldm@tok () Term)

; </end encoding FStar.Algebra.CommMonoid.Fold.fold_equals_seq_foldm>


; <Start encoding FStar.Algebra.CommMonoid.Fold.fold_offset_irrelevance_lemma>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Algebra.CommMonoid.Fold.fold_offset_irrelevance_lemma (Term Term Term Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Algebra.CommMonoid.Fold.fold_offset_irrelevance_lemma@tok () Term)

; </end encoding FStar.Algebra.CommMonoid.Fold.fold_offset_irrelevance_lemma>


; <Start encoding FStar.Algebra.CommMonoid.Fold.fold_offset_elimination_lemma>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Algebra.CommMonoid.Fold.fold_offset_elimination_lemma (Term Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Algebra.CommMonoid.Fold.fold_offset_elimination_lemma@tok () Term)

; </end encoding FStar.Algebra.CommMonoid.Fold.fold_offset_elimination_lemma>


; End Externals for interface FStar.Algebra.CommMonoid.Fold


; UNSAT CORE: @MaxIFuel_assumption, @query, bool_inversion, equation_FStar.IntegerIntervals.interval, equation_FStar.IntegerIntervals.interval_condition, equation_FStar.IntegerIntervals.under, equation_FStar.Matrix.get_i, equation_FStar.Matrix.get_ij, equation_FStar.Matrix.get_j, equation_FStar.Matrix.matrix_seq, equation_Prims.nat, equation_Prims.pos, int_inversion, int_typing, lemma_FStar.Seq.Base.init_index_, lemma_FStar.Seq.Base.lemma_eq_intro, lemma_FStar.Seq.Base.lemma_init_len, primitive_Prims.op_Addition, primitive_Prims.op_AmpAmp, primitive_Prims.op_Division, primitive_Prims.op_LessThan, primitive_Prims.op_LessThanOrEqual, primitive_Prims.op_Modulus, primitive_Prims.op_Multiply, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_0b23d6c7d0419bb206296345badf754b, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, refinement_interpretation_Tm_refine_774ba3f728d91ead8ef40be66c9802e5, refinement_interpretation_Tm_refine_d83f8da8ef6c1cb9f71d1465c1bb1c55, refinement_interpretation_Tm_refine_fcf1a3596fffd49dd2e91f2678358f19, typing_FStar.IntegerIntervals.interval_condition, typing_FStar.Matrix.get_i, typing_FStar.Matrix.get_ij, typing_FStar.Matrix.get_j, typing_FStar.Matrix.matrix_seq

;;; End interface FStar.Algebra.CommMonoid.Fold (46 decls; total size 5565)

; Internals for FStar.Matrix

(push)

; encoding sigelt matrix_generator


; <Start encoding FStar.Matrix.matrix_generator>

(declare-fun FStar.Matrix.matrix_generator (Term Term Term) Term)
;;;;;;;;;;;;;;;;c: Type -> m: Prims.pos -> n: Prims.pos -> Type
(declare-fun Tm_arrow_072f448d6419867e66fd174559d69f4d () Term)
(declare-fun FStar.Matrix.matrix_generator@tok () Term)
;;;;;;;;;;;;;;;;_: FStar.IntegerIntervals.under m -> _: FStar.IntegerIntervals.under n -> c
(declare-fun Tm_arrow_d89ea1aca01bc014386195186f368a45 (Term Term Term) Term)

; </end encoding FStar.Matrix.matrix_generator>


; encoding sigelt matrix


; <Skipped FStar.Matrix.matrix/>


; encoding sigelt matrix


; <Start encoding FStar.Matrix.matrix>

(declare-fun FStar.Matrix.matrix (Term Term Term) Term)

(declare-fun FStar.Matrix.matrix@tok () Term)
(declare-fun Tm_refine_c8b37327a01d03e15569edd59f3dcb3a (Term Term Term) Term)

; </end encoding FStar.Matrix.matrix>


; encoding sigelt flattened_index_is_under_flattened_size


; <Start encoding FStar.Matrix.flattened_index_is_under_flattened_size>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Matrix.flattened_index_is_under_flattened_size (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Matrix.flattened_index_is_under_flattened_size@tok () Term)

; </end encoding FStar.Matrix.flattened_index_is_under_flattened_size>


; encoding sigelt get_ij


; <Start encoding FStar.Matrix.get_ij>
...
(declare-fun Tm_arrow_8cb34bf3ea6b04c87fd57deef2697bb2 () Term)
(declare-fun FStar.Matrix.get_ij@tok () Term)
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.Matrix.get_ij; Namespace FStar.Matrix
(assert (! 
;; def=FStar.Matrix.fsti(50,4-50,10); use=FStar.Matrix.fsti(50,4-50,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Prims.pos)
(HasType @x1
...
(FStar.IntegerIntervals.under @x0))
(HasType @x3
(FStar.IntegerIntervals.under @x1)))
(HasType (FStar.Matrix.get_ij @x0
@x1
@x2
@x3)
(FStar.IntegerIntervals.under (Prims.op_Multiply @x0
@x1))))
 

:pattern ((FStar.Matrix.get_ij @x0
@x1
@x2
@x3))
...
;; def=FStar.Matrix.fsti(50,4-50,10); use=FStar.Matrix.fsti(50,4-50,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (FStar.Matrix.get_ij @x0
@x1
@x2
@x3)
(Prims.op_Addition (Prims.op_Multiply @x2
@x1)
@x3))
...
; </end encoding FStar.Matrix.get_ij>


; encoding sigelt get_i


; <Start encoding FStar.Matrix.get_i>
...
(declare-fun Tm_arrow_3c6b0e4c1b105c8fca1bad98ea16bef2 () Term)
(declare-fun FStar.Matrix.get_i@tok () Term)
;;;;;;;;;;;;;;;;free var typing
...
(FStar.IntegerIntervals.under (Prims.op_Multiply @x0
@x1))))
(HasType (FStar.Matrix.get_i @x0
@x1
@x2)
(FStar.IntegerIntervals.under @x0)))
 

:pattern ((FStar.Matrix.get_i @x0
@x1
@x2))
...
; </end encoding FStar.Matrix.get_i>


; encoding sigelt get_j


; <Start encoding FStar.Matrix.get_j>
...
(declare-fun Tm_arrow_dfa30a1846c4ccb05f75ecac246a4653 () Term)
(declare-fun FStar.Matrix.get_j@tok () Term)
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.Matrix.get_j; Namespace FStar.Matrix
(assert (! 
;; def=FStar.Matrix.fsti(56,4-56,9); use=FStar.Matrix.fsti(56,4-56,9)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Prims.pos)
(HasType @x1
...
(FStar.IntegerIntervals.under (Prims.op_Multiply @x0
@x1))))
(HasType (FStar.Matrix.get_j @x0
@x1
@x2)
(FStar.IntegerIntervals.under @x1)))
 

:pattern ((FStar.Matrix.get_j @x0
@x1
@x2))
...
; </end encoding FStar.Matrix.get_j>


; encoding sigelt consistency_of_i_j


; <Start encoding FStar.Matrix.consistency_of_i_j>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Matrix.consistency_of_i_j (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Matrix.consistency_of_i_j@tok () Term)

; </end encoding FStar.Matrix.consistency_of_i_j>


; encoding sigelt consistency_of_ij


; <Start encoding FStar.Matrix.consistency_of_ij>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Matrix.consistency_of_ij (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Matrix.consistency_of_ij@tok () Term)

; </end encoding FStar.Matrix.consistency_of_ij>


; encoding sigelt transpose_ji


; <Start encoding FStar.Matrix.transpose_ji>

(declare-fun FStar.Matrix.transpose_ji (Term Term Term) Term)
;;;;;;;;;;;;;;;;m: Prims.pos -> n: Prims.pos -> ij: FStar.IntegerIntervals.under (m * n)   -> FStar.IntegerIntervals.under (n * m)
(declare-fun Tm_arrow_b7d70935ba90b3f1b97cfe2be62b7feb () Term)
(declare-fun FStar.Matrix.transpose_ji@tok () Term)

; </end encoding FStar.Matrix.transpose_ji>


; encoding sigelt indices_transpose_lemma


; <Start encoding FStar.Matrix.indices_transpose_lemma>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Matrix.indices_transpose_lemma (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Matrix.indices_transpose_lemma@tok () Term)

; </end encoding FStar.Matrix.indices_transpose_lemma>


; encoding sigelt ji_is_transpose_of_ij


; <Start encoding FStar.Matrix.ji_is_transpose_of_ij>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Matrix.ji_is_transpose_of_ij (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Matrix.ji_is_transpose_of_ij@tok () Term)

; </end encoding FStar.Matrix.ji_is_transpose_of_ij>


; encoding sigelt dual_indices


; <Start encoding FStar.Matrix.dual_indices>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Matrix.dual_indices (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Matrix.dual_indices@tok () Term)

; </end encoding FStar.Matrix.dual_indices>


; encoding sigelt seq_of_matrix


; <Skipped FStar.Matrix.seq_of_matrix/>


; encoding sigelt seq_of_matrix


; <Start encoding FStar.Matrix.seq_of_matrix>

(declare-fun FStar.Matrix.seq_of_matrix (Term Term Term Term) Term)
(declare-fun Tm_refine_d7415981d4014e1e1eaee88cb9b594b5 (Term Term Term) Term)
;;;;;;;;;;;;;;;;mx: matrix c m n   -> s:     FStar.Seq.Base.seq c       { FStar.Seq.Base.length s = m * n /\         (forall (ij: FStar.IntegerIntervals.under (m * n)).             FStar.Seq.Base.index s ij ==             FStar.Seq.Base.index s (get_ij m n (get_i m n ij) (get_j m n ij))) }
(declare-fun Tm_arrow_d3adab66042729e92c911d4a5794513e () Term)
(declare-fun FStar.Matrix.seq_of_matrix@tok () Term)


; </end encoding FStar.Matrix.seq_of_matrix>


; encoding sigelt ijth


; <Skipped FStar.Matrix.ijth/>


; encoding sigelt ijth


; <Start encoding FStar.Matrix.ijth>

(declare-fun FStar.Matrix.ijth (Term Term Term Term Term Term) Term)
(declare-fun Tm_refine_b7a0182f5f3c87ea492ef0012cea087a (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;mx: matrix c m n -> i: FStar.IntegerIntervals.under m -> j: FStar.IntegerIntervals.under n   -> t: c{t == FStar.Seq.Base.index (seq_of_matrix mx) (get_ij m n i j)}
(declare-fun Tm_arrow_54278312b4521e213b905856e41a6695 () Term)
(declare-fun FStar.Matrix.ijth@tok () Term)


; </end encoding FStar.Matrix.ijth>


; encoding sigelt ijth_lemma


; <Skipped FStar.Matrix.ijth_lemma/>


; encoding sigelt ijth_lemma


; <Start encoding FStar.Matrix.ijth_lemma>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Matrix.ijth_lemma (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Matrix.ijth_lemma@tok () Term)

; </end encoding FStar.Matrix.ijth_lemma>


; encoding sigelt matrix_of_seq


; <Skipped FStar.Matrix.matrix_of_seq/>


; encoding sigelt matrix_of_seq


; <Start encoding FStar.Matrix.matrix_of_seq>


(declare-fun FStar.Matrix.matrix_of_seq (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;m: Prims.pos -> n: Prims.pos -> s: FStar.Seq.Base.seq c {FStar.Seq.Base.length s = m * n}   -> matrix c m n
(declare-fun Tm_arrow_2a298c645a390ec1457ee6a5990c8eaf () Term)
(declare-fun FStar.Matrix.matrix_of_seq@tok () Term)


; </end encoding FStar.Matrix.matrix_of_seq>


; encoding sigelt matrix_of


; <Start encoding FStar.Matrix.matrix_of>

(declare-fun FStar.Matrix.matrix_of (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;gen: matrix_generator c m n -> Type
(declare-fun Tm_arrow_a29293527b81be500f703a03028a4419 () Term)
(declare-fun FStar.Matrix.matrix_of@tok () Term)
(declare-fun Tm_refine_ab06a28c4afb9bf873eddd3d9897a683 (Term Term Term Term) Term)

; </end encoding FStar.Matrix.matrix_of>


; encoding sigelt foldm


; <Skipped FStar.Matrix.foldm/>


; encoding sigelt foldm


; <Start encoding FStar.Matrix.foldm>

(declare-fun FStar.Matrix.foldm (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;cm: FStar.Algebra.CommMonoid.Equiv.cm c eq -> mx: matrix c m n -> c
(declare-fun Tm_arrow_bd3b43f48221b366162e7b6605dd8b80 () Term)
(declare-fun FStar.Matrix.foldm@tok () Term)

; </end encoding FStar.Matrix.foldm>


; encoding sigelt matrix_fold_equals_fold_of_seq


; <Skipped FStar.Matrix.matrix_fold_equals_fold_of_seq/>


; encoding sigelt matrix_fold_equals_fold_of_seq


; <Start encoding FStar.Matrix.matrix_fold_equals_fold_of_seq>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Matrix.matrix_fold_equals_fold_of_seq (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Matrix.matrix_fold_equals_fold_of_seq@tok () Term)


; </end encoding FStar.Matrix.matrix_fold_equals_fold_of_seq>


; encoding sigelt matrix_fold_internal


; <Start encoding FStar.Matrix.matrix_fold_internal>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Matrix.matrix_fold_internal (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Matrix.matrix_fold_internal@tok () Term)

; </end encoding FStar.Matrix.matrix_fold_internal>


; encoding sigelt init


; <Skipped FStar.Matrix.init/>


; encoding sigelt init


; <Start encoding FStar.Matrix.init>

(declare-fun FStar.Matrix.init (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;generator: matrix_generator c m n -> matrix_of generator
(declare-fun Tm_arrow_ee4e019d795ef45800cf3eeb4149c9dc () Term)
(declare-fun FStar.Matrix.init@tok () Term)
;;;;;;;;;;;;;;;;ij: FStar.IntegerIntervals.under (m * n) -> c
(declare-fun Tm_arrow_eac552a68bef37cee399306dd697c6a4 (Term Term Term) Term)
(declare-fun Tm_abs_7d63424b9261bac6c73f92aa0d2df7d4 (Term Term Term Term) Term)

; </end encoding FStar.Matrix.init>


; encoding sigelt matrix_seq


; <Start encoding FStar.Matrix.matrix_seq>

(declare-fun FStar.Matrix.matrix_seq (Term Term Term Term) Term)
(declare-fun Tm_refine_0b23d6c7d0419bb206296345badf754b (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.Matrix.matrix_seq; Namespace FStar.Matrix
(assert (! 
;; def=FStar.Matrix.fst(96,64-99,2); use=FStar.Matrix.fst(96,64-99,2)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_0b23d6c7d0419bb206296345badf754b @x2
@x3
@x4
@x5))
(and (HasTypeFuel @u0
...
;; def=FStar.Matrix.fst(96,77-96,98); use=FStar.Matrix.fst(96,77-96,98)
...
;; def=FStar.Matrix.fst(97,2-97,76); use=FStar.Matrix.fst(97,2-97,76)
(forall ((@x6 Term) (@x7 Term))
 (! (implies (and (HasType @x6
(FStar.IntegerIntervals.under @x3))
(HasType @x7
(FStar.IntegerIntervals.under @x4)))

;; def=FStar.Matrix.fst(97,37-97,75); use=FStar.Matrix.fst(97,37-97,75)
(= (FStar.Seq.Base.index @x2
@x1
(FStar.Matrix.get_ij @x3
@x4
@x6
@x7))
(ApplyTT (ApplyTT @x5
...
;;no pats
:qid refinement_interpretation_Tm_refine_0b23d6c7d0419bb206296345badf754b.1))


;; def=FStar.Matrix.fst(98,2-98,79); use=FStar.Matrix.fst(98,2-98,79)
(forall ((@x6 Term))
 (! (implies (HasType @x6
(FStar.IntegerIntervals.under (Prims.op_Multiply @x3
@x4)))

;; def=FStar.Matrix.fst(98,28-98,78); use=FStar.Matrix.fst(98,28-98,78)
(= (FStar.Seq.Base.index @x2
@x1
@x6)
(ApplyTT (ApplyTT @x5
(FStar.Matrix.get_i @x3
@x4
@x6))
(FStar.Matrix.get_j @x3
@x4
@x6)))
)
 
;;no pats
:qid refinement_interpretation_Tm_refine_0b23d6c7d0419bb206296345badf754b.2))
))
...
@x4
@x5)))
:qid refinement_interpretation_Tm_refine_0b23d6c7d0419bb206296345badf754b))

:named refinement_interpretation_Tm_refine_0b23d6c7d0419bb206296345badf754b))
;;;;;;;;;;;;;;;;gen: matrix_generator c m n   -> t:     FStar.Seq.Base.seq c       { FStar.Seq.Base.length t = m * n /\         (forall (i: FStar.IntegerIntervals.under m) (j: FStar.IntegerIntervals.under n).             FStar.Seq.Base.index t (get_ij m n i j) == gen i j) /\         (forall (ij: FStar.IntegerIntervals.under (m * n)).             FStar.Seq.Base.index t ij == gen (get_i m n ij) (get_j m n ij)) }
(declare-fun Tm_arrow_96b2783b37dba85e3bbe5320d63724fa () Term)
(declare-fun FStar.Matrix.matrix_seq@tok () Term)

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.Matrix.matrix_seq; Namespace FStar.Matrix
(assert (! 
;; def=FStar.Matrix.fst(96,12-96,22); use=FStar.Matrix.fst(96,12-96,22)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
Prims.pos)
(HasType @x3
(FStar.Matrix.matrix_generator @x0
@x1
@x2)))
(HasType (FStar.Matrix.matrix_seq @x0
@x1
@x2
@x3)
(Tm_refine_0b23d6c7d0419bb206296345badf754b @x0
@x1
@x2
@x3)))
 

:pattern ((FStar.Matrix.matrix_seq @x0
@x1
@x2
@x3))
:qid typing_FStar.Matrix.matrix_seq))

:named typing_FStar.Matrix.matrix_seq))
;;;;;;;;;;;;;;;;Equation for FStar.Matrix.matrix_seq
;;; Fact-ids: Name FStar.Matrix.matrix_seq; Namespace FStar.Matrix
(assert (! 
;; def=FStar.Matrix.fst(96,12-96,22); use=FStar.Matrix.fst(96,12-96,22)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (FStar.Matrix.matrix_seq @x0
@x1
@x2
@x3)
(FStar.Matrix.init @x0
@x1
@x2
@x3))
...
@x2
@x3))
:qid equation_FStar.Matrix.matrix_seq))

:named equation_FStar.Matrix.matrix_seq))

; </end encoding FStar.Matrix.matrix_seq>


; encoding sigelt matrix_append_snoc_lemma


; <Start encoding FStar.Matrix.matrix_append_snoc_lemma>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Matrix.matrix_append_snoc_lemma (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Matrix.matrix_append_snoc_lemma@tok () Term)

; </end encoding FStar.Matrix.matrix_append_snoc_lemma>


; encoding sigelt matrix_seq_decomposition_lemma


; <Start encoding FStar.Matrix.matrix_seq_decomposition_lemma>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Matrix.matrix_seq_decomposition_lemma (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Matrix.matrix_seq_decomposition_lemma@tok () Term)

; </end encoding FStar.Matrix.matrix_seq_decomposition_lemma>


; encoding sigelt matrix_fold_snoc_lemma


; <Start encoding FStar.Matrix.matrix_fold_snoc_lemma>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Matrix.matrix_fold_snoc_lemma (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Matrix.matrix_fold_snoc_lemma@tok () Term)

; </end encoding FStar.Matrix.matrix_fold_snoc_lemma>


; encoding sigelt matrix_submatrix_lemma


; <Start encoding FStar.Matrix.matrix_submatrix_lemma>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Matrix.matrix_submatrix_lemma (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Matrix.matrix_submatrix_lemma@tok () Term)

; </end encoding FStar.Matrix.matrix_submatrix_lemma>


; Starting query at FStar.Matrix.fst(154,2-154,67)
...
;;;;;;;;;;;;;;;;_: FStar.IntegerIntervals.under n -> c
(declare-fun Tm_arrow_407505b74b874ef27378efcc7dafe696 (Term Term) Term)




; Encoding query formula : forall (c: Type) (m: Prims.pos) (n: Prims.pos) (generator: FStar.Matrix.matrix_generator c m n).
;   (forall (_: Prims.squash (m == 1)).
;       (*could not prove post-condition*)
;       (n > 0 ==> n >= 0) /\
;       (forall (any_result: Prims.pos).
;           n == any_result ==>
;           FStar.IntegerIntervals.interval_condition 0 m 0 /\
;           (forall (any_result: Prims.int).
;               0 == any_result ==>
;               (forall (any_result: (_: FStar.IntegerIntervals.under n -> c)).
;                   generator 0 == any_result ==>
;                   (forall (i: Prims.int).
;                       i >= 0 /\ i < n ==> FStar.IntegerIntervals.interval_condition 0 n i))))) /\
;   (forall (p: Prims.pure_post Prims.unit).
;       m == 1 /\
;       (forall (pure_result: Prims.unit).
;           FStar.Matrix.matrix_seq generator == FStar.Seq.Base.init n (generator 0) ==> p pure_result
;       ) ==>
;       (n > 0 ==> n >= 0) /\
;       (forall (any_result: Prims.pos).
;           n == any_result ==>
...
;                   (forall (i: Prims.int).
;                       i >= 0 /\ i < n ==> FStar.IntegerIntervals.interval_condition 0 n i) /\
;                   (forall (return_val: (i: Prims.nat{i < n} -> c)).
;                       return_val == generator 0 ==>
;                       generator 0 == return_val ==>
;                       (forall (any_result: FStar.Seq.Base.seq c).
;                           FStar.Seq.Base.init n (generator 0) == any_result ==>
;                           FStar.Seq.Base.equal (FStar.Matrix.matrix_seq generator)
;                             (FStar.Seq.Base.init n (generator 0)) /\
;                           (forall (pure_result: Prims.unit).
...
(and 
;; def= dummy(0,0-0,0); use=FStar.Matrix.fst(154,2-154,67)
(forall ((@x4 Term))
 (! (implies (HasType @x4
(Tm_refine_493726b0caab6179254e314147227b49 @x1))

;; def=prims.fst(438,77-438,89); use=FStar.Matrix.fst(154,2-154,67)
(and (implies 
;; def=prims.fst(662,18-662,23); use=FStar.Matrix.fst(154,2-154,67)
(> (BoxInt_proj_0 @x2)
(BoxInt_proj_0 (BoxInt 0)))


;; def=prims.fst(659,18-659,24); use=FStar.Matrix.fst(153,52-153,53)
(or label_1

;; def=prims.fst(659,18-659,24); use=FStar.Matrix.fst(154,2-154,67)
(>= (BoxInt_proj_0 @x2)
(BoxInt_proj_0 (BoxInt 0)))
)
)

;; def=prims.fst(430,66-430,102); use=FStar.Matrix.fst(154,2-154,67)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.pos)

;; def=FStar.Seq.Base.fsti(35,43-35,46); use=FStar.Matrix.fst(154,2-154,67)
(= @x2
@x5)
)
...
;; def=prims.fst(438,77-438,89); use=FStar.Matrix.fst(154,2-154,67)
(and 
;; def=FStar.IntegerIntervals.fst(38,53-38,77); use=FStar.Matrix.fst(153,65-153,66)
(or label_2

;; def=FStar.IntegerIntervals.fst(38,53-38,77); use=FStar.Matrix.fst(154,2-154,67)
(BoxBool_proj_0 (FStar.IntegerIntervals.interval_condition (BoxInt 0)
@x1
(BoxInt 0)))
)
...
(Tm_arrow_407505b74b874ef27378efcc7dafe696 @x0
@x2))

;; def=FStar.Seq.Base.fsti(35,33-35,82); use=FStar.Matrix.fst(154,2-154,67)
(= (ApplyTT @x3
(BoxInt 0))
@x7)
)
...
;; def=FStar.Seq.Base.fsti(35,73-35,80); use=FStar.Matrix.fst(154,2-154,67)
(< (BoxInt_proj_0 @x8)
(BoxInt_proj_0 @x2))
)

;; def=FStar.IntegerIntervals.fst(38,53-38,77); use=FStar.Matrix.fst(153,54-153,67)
(or label_3
...
;; def=FStar.Matrix.fst(152,20-152,24); use=FStar.Matrix.fst(154,2-154,67)
(= @x1
(BoxInt 1))


;; def=prims.fst(420,36-420,97); use=FStar.Matrix.fst(154,2-154,67)
(forall ((@x5 Term))
 (! (implies (and (or label_4
(HasType @x5
Prims.unit))

;; def=FStar.Matrix.fst(153,19-153,68); use=FStar.Matrix.fst(154,2-154,67)
(or label_5
...
;; def=prims.fst(420,83-420,96); use=FStar.Matrix.fst(154,2-154,67)
(Valid 
;; def=prims.fst(420,83-420,96); use=FStar.Matrix.fst(154,2-154,67)
(ApplyTT @x4
@x5)
...
;; def=prims.fst(438,77-438,89); use=FStar.Matrix.fst(154,2-154,67)
(and (implies 
;; def=prims.fst(662,18-662,23); use=FStar.Matrix.fst(154,51-154,52)
(> (BoxInt_proj_0 @x2)
(BoxInt_proj_0 (BoxInt 0)))


;; def=prims.fst(659,18-659,24); use=FStar.Matrix.fst(154,51-154,52)
(or label_6
...
;; def=prims.fst(438,77-438,89); use=FStar.Matrix.fst(154,2-154,67)
(and 
;; def=FStar.IntegerIntervals.fst(38,53-38,77); use=FStar.Matrix.fst(154,64-154,65)
(or label_7
...
;; def=FStar.Seq.Base.fsti(35,33-35,82); use=FStar.Matrix.fst(154,46-154,66)
(= (ApplyTT @x3
(BoxInt 0))
@x7)
)
...
;; def=prims.fst(438,77-438,89); use=FStar.Matrix.fst(154,2-154,67)
(and 
;; def= dummy(0,0-0,0); use=FStar.Matrix.fst(154,53-154,66)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
Prims.int)

;; def=prims.fst(659,18-659,24); use=FStar.Matrix.fst(154,53-154,66)
(>= (BoxInt_proj_0 @x8)
(BoxInt_proj_0 (BoxInt 0)))


;; def=FStar.Seq.Base.fsti(35,73-35,80); use=FStar.Matrix.fst(154,53-154,66)
(< (BoxInt_proj_0 @x8)
(BoxInt_proj_0 @x2))
)

;; def=FStar.IntegerIntervals.fst(38,53-38,77); use=FStar.Matrix.fst(154,53-154,66)
(or label_8
...
;; def=prims.fst(335,2-335,58); use=FStar.Matrix.fst(154,2-154,67)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
(Tm_arrow_44bb45ed5c2534b346e0f58ea5033251 @x0
@x2))

;; def=prims.fst(335,26-335,41); use=FStar.Matrix.fst(154,2-154,67)
(= @x8
(ApplyTT @x3
(BoxInt 0)))


;; def=FStar.Seq.Base.fsti(35,54-35,62); use=FStar.Matrix.fst(154,2-154,67)
(= (ApplyTT @x3
(BoxInt 0))
@x8)
)
...
;; def=FStar.Seq.Base.fsti(156,42-156,44); use=FStar.Matrix.fst(154,2-154,67)
(= (FStar.Seq.Base.init @x0
@x2
(ApplyTT @x3
(BoxInt 0)))
...
;; def=prims.fst(420,29-420,97); use=FStar.Matrix.fst(154,5-154,18)
(and 
;; def=FStar.Seq.Base.fsti(157,15-157,28); use=FStar.Matrix.fst(154,5-154,18)
(or label_9
...
;; def=prims.fst(420,36-420,97); use=FStar.Matrix.fst(154,5-154,18)
(forall ((@x10 Term))
 (! (implies (and (HasType @x10
Prims.unit)

;; def=FStar.Seq.Base.fsti(158,14-158,22); use=FStar.Matrix.fst(154,5-154,18)
(= (FStar.Matrix.matrix_seq @x0
@x1
@x2
@x3)
...
;; def=prims.fst(420,83-420,96); use=FStar.Matrix.fst(154,5-154,18)
(Valid 
;; def=prims.fst(420,83-420,96); use=FStar.Matrix.fst(154,5-154,18)
(ApplyTT @x4
@x10)
