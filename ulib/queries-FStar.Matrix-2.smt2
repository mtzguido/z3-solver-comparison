...
;;; End module FStar.Pervasives.Native (1325 decls; total size 132952)
...
;;; End interface FStar.Pervasives (1419 decls; total size 84242)
...
;;; End interface FStar.Classical (203 decls; total size 14708)
...
;;; End module FStar.StrongExcludedMiddle (10 decls; total size 1191)
...
;;; End interface FStar.Classical.Sugar (136 decls; total size 7260)
...
;;; End module FStar.List.Tot.Base (675 decls; total size 87934)
...
;;; End module FStar.List.Tot.Properties (527 decls; total size 51970)
...
;;; End module FStar.List.Tot (3 decls; total size 663)
...
;;; End interface FStar.Seq.Base (261 decls; total size 17570)
...
;;; End module FStar.IntegerIntervals (123 decls; total size 11682)
...
;;; End interface FStar.Seq.Properties (842 decls; total size 76271)
...
;;; End module FStar.Mul (8 decls; total size 824)
...
;;; End module FStar.Algebra.CommMonoid.Equiv (343 decls; total size 21963)
...
;;; End interface FStar.Seq.Equiv (41 decls; total size 4164)
...
;;; End interface FStar.Sealed (17 decls; total size 1447)
...
;;; End interface FStar.Range (22 decls; total size 1785)
...
;;; End module FStar.Preorder (56 decls; total size 2901)
...
;;; End interface FStar.Calc (50 decls; total size 3583)
...
;;; End module FStar.Math.Lib (158 decls; total size 13297)
...
;;; End module FStar.Math.Lemmas (616 decls; total size 52548)
...
;;; End module FStar.Seq (3 decls; total size 653)
...
;;; End interface FStar.Seq.Permutation (104 decls; total size 9037)
...
;;; End interface FStar.Algebra.CommMonoid.Fold (46 decls; total size 4864)
...
; Starting query at FStar.Matrix.fsti(46,32-46,55)
...
; Encoding query formula : forall (m: Prims.pos)
;   (n: Prims.pos)
;   (i: FStar.IntegerIntervals.under m)
;   (j: FStar.IntegerIntervals.under n).
;   (*could not prove post-condition*)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit). i * n + j < m * n ==> p pure_result) ==>
;     i * n <= (m - 1) * n /\
;     (forall (pure_result: Prims.unit). i * n <= (m - 1) * n ==> p pure_result)
...
;; def=prims.fst(420,36-420,97); use=FStar.Matrix.fsti(46,32-46,55)
(forall ((@x5 Term))
 (! (implies (and (or label_1
(HasType @x5
Prims.unit))

;; def=FStar.Matrix.fsti(46,10-46,29); use=FStar.Matrix.fsti(46,32-46,55)
(or label_2

;; def=FStar.Matrix.fsti(46,10-46,29); use=FStar.Matrix.fsti(46,32-46,55)
(< (BoxInt_proj_0 (Prims.op_Addition (Prims.op_Multiply @x2
@x1)
@x3))
...
;; def=prims.fst(420,83-420,96); use=FStar.Matrix.fsti(46,32-46,55)
(Valid 
;; def=prims.fst(420,83-420,96); use=FStar.Matrix.fsti(46,32-46,55)
(ApplyTT @x4
@x5)
...
;; def=prims.fst(420,29-420,97); use=FStar.Matrix.fsti(46,32-46,55)
(and 
;; def=FStar.Matrix.fsti(46,39-46,55); use=FStar.Matrix.fsti(46,39-46,55)
(or label_3

;; def=FStar.Matrix.fsti(46,39-46,55); use=FStar.Matrix.fsti(46,39-46,55)
(<= (BoxInt_proj_0 (Prims.op_Multiply @x2
@x1))
(BoxInt_proj_0 (Prims.op_Multiply (Prims.op_Subtraction @x0
(BoxInt 1))
@x1)))
)
...
;; def=FStar.Matrix.fsti(46,39-46,55); use=FStar.Matrix.fsti(46,32-46,38)
(<= (BoxInt_proj_0 (Prims.op_Multiply @x2
@x1))
(BoxInt_proj_0 (Prims.op_Multiply (Prims.op_Subtraction @x0
(BoxInt 1))
