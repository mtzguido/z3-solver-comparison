...
; UNSAT CORE: @MaxIFuel_assumption, @query, int_inversion, int_typing, primitive_Prims.op_Addition, primitive_Prims.op_Multiply, projection_inverse_BoxInt_proj_0

;;; End module Prims (645 decls; total size 34321)
...
;;; End module FStar.Pervasives.Native (1325 decls; total size 132536)
...
;;; End interface FStar.Pervasives (1419 decls; total size 83826)
...
;;; End interface FStar.Sealed (17 decls; total size 1031)
...
;;; End interface FStar.Range (22 decls; total size 1369)
...
;;; End module FStar.Preorder (56 decls; total size 2589)
...
;;; End interface FStar.Calc (50 decls; total size 3377)
...
;;; End module FStar.Mul (8 decls; total size 408)
...
;;; End module FStar.Math.Lib (158 decls; total size 12881)
...
; Starting query at FStar.Math.Lemmas.fst(75,36-75,38)

(push)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (a: Prims.int) (b: Prims.int) (c: Prims.int).
;   (*could not prove post-condition*)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit). (a + b) * c = a * c + b * c ==> p pure_result) ==>
...
;; def=prims.fst(420,36-420,97); use=FStar.Math.Lemmas.fst(75,36-75,38)
(forall ((@x4 Term))
 (! (implies (and (or label_1
(HasType @x4
Prims.unit))

;; def=FStar.Math.Lemmas.fst(74,2-74,31); use=FStar.Math.Lemmas.fst(75,36-75,38)
(or label_2

;; def=FStar.Math.Lemmas.fst(74,2-74,31); use=FStar.Math.Lemmas.fst(75,36-75,38)
(= (Prims.op_Multiply (Prims.op_Addition @x0
@x1)
@x2)
(Prims.op_Addition (Prims.op_Multiply @x0
@x2)
...
;; def=prims.fst(420,83-420,96); use=FStar.Math.Lemmas.fst(75,36-75,38)
(Valid 
;; def=prims.fst(420,83-420,96); use=FStar.Math.Lemmas.fst(75,36-75,38)
(ApplyTT @x3
@x4)
