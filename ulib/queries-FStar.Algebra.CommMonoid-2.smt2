...
; UNSAT CORE: @MaxIFuel_assumption, @query, int_inversion, primitive_Prims.op_Multiply, projection_inverse_BoxInt_proj_0

;;; End module Prims (643 decls; total size 33712)
...
;;; End module FStar.Pervasives.Native (1325 decls; total size 132495)
...
;;; End interface FStar.Pervasives (1419 decls; total size 83785)
...
;;; End module FStar.Mul (8 decls; total size 367)

; Internals for FStar.Algebra.CommMonoid
...
;;;;;;;;;;;;;;;;Constructor
(declare-fun FStar.Algebra.CommMonoid.cm (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun FStar.Algebra.CommMonoid.cm@x0 (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun FStar.Algebra.CommMonoid.cm@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun FStar.Algebra.CommMonoid.CM (Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun FStar.Algebra.CommMonoid.CM_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun FStar.Algebra.CommMonoid.CM_unit (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun FStar.Algebra.CommMonoid.CM_mult (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun FStar.Algebra.CommMonoid.CM_identity (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun FStar.Algebra.CommMonoid.CM_associativity (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun FStar.Algebra.CommMonoid.CM_commutativity (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: CM
(declare-fun FStar.Algebra.CommMonoid.CM@tok () Term)
;;;;;;;;;;;;;;;;_: a -> _: a -> a
(declare-fun Tm_arrow_72ac2ec523211f8603e00b25deb1543b (Term) Term)
(declare-fun Tm_refine_5408e6d8e0c1f93f5a74b3cce86fa90d (Term Term Term) Term)
;;;;;;;;;;;;;;;;x: a -> FStar.Pervasives.Lemma (ensures mult unit x == x)
(declare-fun Tm_arrow_c1d6192ec8fb1fa9bc0ab6a94f25c3e2 (Term Term Term) Term)
(declare-fun Tm_refine_bc7da5704acd37a40f84289399f6cbf8 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;x: a -> y: a -> z: a -> FStar.Pervasives.Lemma (ensures mult (mult x y) z == mult x (mult y z))
(declare-fun Tm_arrow_9975d018af81a325c298730f866f4b56 (Term Term) Term)
(declare-fun Tm_refine_4c7dcaed5cb85709e1374a35070247a6 (Term Term Term) Term)
;;;;;;;;;;;;;;;;x: a -> y: a -> FStar.Pervasives.Lemma (ensures mult x y == mult y x)
(declare-fun Tm_arrow_8f2c909cc77a6360ffea019409a9ceca (Term Term) Term)
...
;;;;;;;;;;;;;;;;unit: a ->     mult: (_: a -> _: a -> a) ->     identity: (x: a -> FStar.Pervasives.Lemma (ensures mult unit x == x)) ->     associativity:       (x: a -> y: a -> z: a           -> FStar.Pervasives.Lemma (ensures mult (mult x y) z == mult x (mult y z))) ->     commutativity: (x: a -> y: a -> FStar.Pervasives.Lemma (ensures mult x y == mult y x))   -> cm a
(declare-fun Tm_arrow_e9b881f4a212674f03872209a3435a68 () Term)

; <Start encoding FStar.Algebra.CommMonoid.cm>


; <start constructor FStar.Algebra.CommMonoid.cm>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-FStar.Algebra.CommMonoid.cm ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
104)
(exists ((@x0 Term))
 (! (= __@x0
(FStar.Algebra.CommMonoid.cm @x0))
 
;;no pats
:qid is-FStar.Algebra.CommMonoid.cm))))

; </end constructor FStar.Algebra.CommMonoid.cm>


; </end encoding FStar.Algebra.CommMonoid.cm>
...
122)
(= __@x0
(FStar.Algebra.CommMonoid.CM (FStar.Algebra.CommMonoid.CM_a __@x0)
(FStar.Algebra.CommMonoid.CM_unit __@x0)
(FStar.Algebra.CommMonoid.CM_mult __@x0)
(FStar.Algebra.CommMonoid.CM_identity __@x0)
(FStar.Algebra.CommMonoid.CM_associativity __@x0)
(FStar.Algebra.CommMonoid.CM_commutativity __@x0)))))
...
; <Start encoding FStar.Algebra.CommMonoid.cm__uu___haseq>
...
; </end encoding FStar.Algebra.CommMonoid.cm__uu___haseq>


; encoding sigelt uu___is_CM


; <Start encoding FStar.Algebra.CommMonoid.uu___is_CM>

(declare-fun FStar.Algebra.CommMonoid.uu___is_CM (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: cm a -> Prims.bool
(declare-fun Tm_arrow_00cc78424fcb36377142cb47b6eeb25f () Term)
(declare-fun FStar.Algebra.CommMonoid.uu___is_CM@tok () Term)

; </end encoding FStar.Algebra.CommMonoid.uu___is_CM>


; encoding sigelt uu___is_CM


; <Skipped FStar.Algebra.CommMonoid.uu___is_CM/>


; encoding sigelt __proj__CM__item__unit


; <Start encoding FStar.Algebra.CommMonoid.__proj__CM__item__unit>

(declare-fun FStar.Algebra.CommMonoid.__proj__CM__item__unit (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: cm a -> a
(declare-fun Tm_arrow_d5852332626c2122baa7056a9308d02f () Term)
(declare-fun FStar.Algebra.CommMonoid.__proj__CM__item__unit@tok () Term)

; </end encoding FStar.Algebra.CommMonoid.__proj__CM__item__unit>


; encoding sigelt __proj__CM__item__unit


; <Skipped FStar.Algebra.CommMonoid.__proj__CM__item__unit/>


; encoding sigelt __proj__CM__item__mult


; <Start encoding FStar.Algebra.CommMonoid.__proj__CM__item__mult>

(declare-fun FStar.Algebra.CommMonoid.__proj__CM__item__mult (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: cm a -> _: a -> _: a -> a
(declare-fun Tm_arrow_bcea4a6a63083a6aab2b4d714ada1e8c () Term)
(declare-fun FStar.Algebra.CommMonoid.__proj__CM__item__mult@tok () Term)


; </end encoding FStar.Algebra.CommMonoid.__proj__CM__item__mult>


; encoding sigelt __proj__CM__item__mult


; <Skipped FStar.Algebra.CommMonoid.__proj__CM__item__mult/>


; encoding sigelt __proj__CM__item__identity


; <Start encoding FStar.Algebra.CommMonoid.__proj__CM__item__identity>

(declare-fun FStar.Algebra.CommMonoid.__proj__CM__item__identity (Term Term) Term)
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name FStar.Algebra.CommMonoid.__proj__CM__item__identity; Namespace FStar.Algebra.CommMonoid
(assert (! (Valid (ApplyTT __uu__PartialApp
FStar.Algebra.CommMonoid.__proj__CM__item__mult@tok))
:named @kick_partial_app_5a3a9ae10bfd6e5a03647678f434b2d6))
(declare-fun Tm_refine_92f95f500d7a129c82f1f2467ba19504 (Term Term Term) Term)
;;;;;;;;;;;;;;;;x: a -> FStar.Pervasives.Lemma (ensures CM?.mult projectee (CM?.unit projectee) x == x)
(declare-fun Tm_arrow_d98afcea4f282222e6e635e07c00f7e0 (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: cm a -> x: a   -> FStar.Pervasives.Lemma (ensures CM?.mult projectee (CM?.unit projectee) x == x)
(declare-fun Tm_arrow_2701e26e23bfa41ccfde5a44e1ee4db6 () Term)
(declare-fun FStar.Algebra.CommMonoid.__proj__CM__item__identity@tok () Term)




; </end encoding FStar.Algebra.CommMonoid.__proj__CM__item__identity>


; encoding sigelt __proj__CM__item__identity


; <Skipped FStar.Algebra.CommMonoid.__proj__CM__item__identity/>


; encoding sigelt __proj__CM__item__associativity


; <Start encoding FStar.Algebra.CommMonoid.__proj__CM__item__associativity>

(declare-fun FStar.Algebra.CommMonoid.__proj__CM__item__associativity (Term Term) Term)




(declare-fun Tm_refine_dc97efb3a52db8aa0cd0fff738e5d2ee (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;x: a -> y: a -> z: a   -> FStar.Pervasives.Lemma     (ensures       CM?.mult projectee (CM?.mult projectee x y) z == CM?.mult projectee x (CM?.mult projectee y z)     )
(declare-fun Tm_arrow_815bf4019caaffad41da91d2ad8509c6 (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: cm a -> x: a -> y: a -> z: a   -> FStar.Pervasives.Lemma     (ensures       CM?.mult projectee (CM?.mult projectee x y) z == CM?.mult projectee x (CM?.mult projectee y z)     )
(declare-fun Tm_arrow_0f4ad14e131995863151a55131e4d76b () Term)
(declare-fun FStar.Algebra.CommMonoid.__proj__CM__item__associativity@tok () Term)
...
; </end encoding FStar.Algebra.CommMonoid.__proj__CM__item__associativity>


; encoding sigelt __proj__CM__item__associativity


; <Skipped FStar.Algebra.CommMonoid.__proj__CM__item__associativity/>


; encoding sigelt __proj__CM__item__commutativity


; <Start encoding FStar.Algebra.CommMonoid.__proj__CM__item__commutativity>

(declare-fun FStar.Algebra.CommMonoid.__proj__CM__item__commutativity (Term Term) Term)


(declare-fun Tm_refine_a744b10cfc4f9e391010901e81d450af (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;x: a -> y: a -> FStar.Pervasives.Lemma (ensures CM?.mult projectee x y == CM?.mult projectee y x)
(declare-fun Tm_arrow_ac7ed44c9221972cb24d2a5e34fbbbde (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: cm a -> x: a -> y: a   -> FStar.Pervasives.Lemma (ensures CM?.mult projectee x y == CM?.mult projectee y x)
(declare-fun Tm_arrow_19a075059383d8be58bd3c6bd9d301d1 () Term)
(declare-fun FStar.Algebra.CommMonoid.__proj__CM__item__commutativity@tok () Term)





; </end encoding FStar.Algebra.CommMonoid.__proj__CM__item__commutativity>


; encoding sigelt __proj__CM__item__commutativity


; <Skipped FStar.Algebra.CommMonoid.__proj__CM__item__commutativity/>


; encoding sigelt right_identity


; <Start encoding FStar.Algebra.CommMonoid.right_identity>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun FStar.Algebra.CommMonoid.right_identity (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun FStar.Algebra.CommMonoid.right_identity@tok () Term)

; </end encoding FStar.Algebra.CommMonoid.right_identity>


; encoding sigelt int_plus_cm


; <Start encoding FStar.Algebra.CommMonoid.int_plus_cm>

(declare-fun FStar.Algebra.CommMonoid.int_plus_cm (Dummy_sort) Term)
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name FStar.Algebra.CommMonoid.int_plus_cm; Namespace FStar.Algebra.CommMonoid
(assert (! (Valid (ApplyTT __uu__PartialApp
...
; </end encoding FStar.Algebra.CommMonoid.int_plus_cm>


; Starting query at FStar.Algebra.CommMonoid.fst(38,0-39,60)
...
(declare-fun Tm_refine_56a4462b8e70b75686f8bedde4d85e8e (Term) Term)
;;;;;;;;;;;;;;;;x: Prims.int -> FStar.Pervasives.Lemma (ensures 1 * x == x)
(declare-fun Tm_arrow_4566e9f8a2f834e7d068f7ae9f9e54be () Term)
(declare-fun Tm_refine_2a92b8e2cba233638d64b538505f70b3 (Term Term Term) Term)
;;;;;;;;;;;;;;;;x: Prims.int -> y: Prims.int -> z: Prims.int   -> FStar.Pervasives.Lemma (ensures (x * y) * z == x * (y * z))
(declare-fun Tm_arrow_22a0fa40a2d3389aa8111c41fa3e4a2e () Term)

; Encoding query formula : (forall (x: Prims.int).
;     (*could not prove post-condition*)
;     forall (p: Prims.pure_post Prims.unit).
;       (forall (pure_result: Prims.unit). 1 * x == x ==> p pure_result) ==>
;       (forall (any_result: Prims.unit). p any_result)) /\
; (forall (any_result: (x: Prims.int -> FStar.Pervasives.Lemma (ensures 1 * x == x))).
;     (forall (x: Prims.int) (y: Prims.int) (z: Prims.int).
;         (*could not prove post-condition*)
;         forall (p: Prims.pure_post Prims.unit).
;           (forall (pure_result: Prims.unit). (x * y) * z == x * (y * z) ==> p pure_result) ==>
;           (forall (any_result: Prims.unit). p any_result)) /\
;     (forall (any_result:
...
;         (*could not prove post-condition*)
;         forall (p: Prims.pure_post Prims.unit).
;           (forall (pure_result: Prims.unit). x * y == y * x ==> p pure_result) ==>
;           (forall (any_result: Prims.unit). p any_result)))
...
;; def=prims.fst(420,36-420,97); use=FStar.Algebra.CommMonoid.fst(39,23-39,25)
(forall ((@x2 Term))
 (! (implies (and (or label_1
(HasType @x2
Prims.unit))

;; def=FStar.Algebra.CommMonoid.fst(25,29-25,49); use=FStar.Algebra.CommMonoid.fst(39,23-39,25)
(or label_2
...
;; def=prims.fst(420,83-420,96); use=FStar.Algebra.CommMonoid.fst(39,23-39,25)
(Valid 
;; def=prims.fst(420,83-420,96); use=FStar.Algebra.CommMonoid.fst(39,23-39,25)
(ApplyTT @x1
@x2)
...
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_arrow_4566e9f8a2f834e7d068f7ae9f9e54be)
...
;; def=prims.fst(420,36-420,97); use=FStar.Algebra.CommMonoid.fst(39,41-39,43)
(forall ((@x5 Term))
 (! (implies (and (or label_3
(HasType @x5
Prims.unit))

;; def=FStar.Algebra.CommMonoid.fst(27,28-27,74); use=FStar.Algebra.CommMonoid.fst(39,41-39,43)
(or label_4
...
;; def=prims.fst(420,83-420,96); use=FStar.Algebra.CommMonoid.fst(39,41-39,43)
(Valid 
;; def=prims.fst(420,83-420,96); use=FStar.Algebra.CommMonoid.fst(39,41-39,43)
(ApplyTT @x4
@x5)
...
(forall ((@x1 Term))
 (! (implies (HasType @x1
Tm_arrow_22a0fa40a2d3389aa8111c41fa3e4a2e)
...
;; def=prims.fst(420,36-420,97); use=FStar.Algebra.CommMonoid.fst(39,57-39,59)
(forall ((@x5 Term))
 (! (implies (and (or label_5
(HasType @x5
Prims.unit))

;; def=FStar.Algebra.CommMonoid.fst(28,39-28,65); use=FStar.Algebra.CommMonoid.fst(39,57-39,59)
(or label_6
...
;; def=prims.fst(420,83-420,96); use=FStar.Algebra.CommMonoid.fst(39,57-39,59)
(Valid 
;; def=prims.fst(420,83-420,96); use=FStar.Algebra.CommMonoid.fst(39,57-39,59)
(ApplyTT @x4
@x5)
