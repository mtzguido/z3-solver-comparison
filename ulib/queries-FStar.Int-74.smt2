...
;;; End module FStar.Pervasives.Native (1325 decls; total size 135116)
...
;;; End interface FStar.Pervasives (1419 decls; total size 86406)
...
;;; End interface FStar.Classical (203 decls; total size 16872)
...
;;; End module FStar.StrongExcludedMiddle (10 decls; total size 3355)
...
;;; End interface FStar.Classical.Sugar (136 decls; total size 9424)
...
;;; End module FStar.List.Tot.Base (675 decls; total size 90098)
...
;;; End module FStar.List.Tot.Properties (527 decls; total size 54134)
...
;;; End module FStar.List.Tot (3 decls; total size 2827)
...
;;; End interface FStar.Seq.Base (272 decls; total size 27320)
...
;;; End interface FStar.Seq.Properties (842 decls; total size 78435)
...
;;; End module FStar.Seq (3 decls; total size 2817)
...
;;; End interface FStar.Sealed (17 decls; total size 3611)
...
;;; End interface FStar.Range (22 decls; total size 3949)
...
;;; End module FStar.Preorder (56 decls; total size 5169)
...
;;; End interface FStar.Calc (50 decls; total size 5747)
...
;;; End module FStar.Mul (8 decls; total size 2988)
...
;;; End module FStar.Math.Lib (158 decls; total size 15461)
...
;;; End module FStar.Math.Lemmas (616 decls; total size 54712)
...
(assert (! 
;; def=FStar.BitVector.fst(42,4-42,12); use=FStar.BitVector.fst(42,4-42,12)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.pos)
(HasType (FStar.BitVector.ones_vec @x0)
(FStar.BitVector.bv_t @x0)))
...
;;; End module FStar.BitVector (158 decls; total size 20135)
...
(assert (! 
;; def=FStar.UInt.fsti(429,41-429,54); use=FStar.UInt.fsti(429,41-429,54)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
...
;; def=FStar.UInt.fsti(429,47-429,53); use=FStar.UInt.fsti(429,47-429,53)
(<= (BoxInt_proj_0 @x1)
(BoxInt_proj_0 @x2))
))
...
;; def=FStar.UInt.fsti(431,17-433,68); use=FStar.UInt.fsti(431,17-433,68)
(and 
;; def=FStar.UInt.fsti(431,18-431,34); use=FStar.UInt.fsti(431,18-431,34)
...
;; def=FStar.UInt.fsti(432,10-432,67); use=FStar.UInt.fsti(432,10-432,67)
(implies 
;; def=FStar.UInt.fsti(432,11-432,20); use=FStar.UInt.fsti(432,11-432,20)
(< (BoxInt_proj_0 @x2)
(BoxInt_proj_0 (Prims.op_Subtraction @x0
@x1)))


;; def=FStar.UInt.fsti(432,25-432,66); use=FStar.UInt.fsti(432,25-432,66)
...
(implies 
;; def=FStar.UInt.fsti(433,11-433,21); use=FStar.UInt.fsti(433,11-433,21)
(<= (BoxInt_proj_0 (Prims.op_Subtraction @x0
@x1))
(BoxInt_proj_0 @x2))


;; def=FStar.UInt.fsti(433,26-433,66); use=FStar.UInt.fsti(433,26-433,66)
(= (FStar.Seq.Base.index Prims.bool
(FStar.UInt.to_vec.fuel_instrumented ZFuel
@x0
(Prims.op_Subtraction (Prims.pow2.fuel_instrumented ZFuel
...
;;; End interface FStar.UInt (722 decls; total size 59378)
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name FStar.Int.ones; Namespace FStar.Int
(assert (! 
;; def=FStar.Int.fsti(78,4-78,8); use=FStar.Int.fsti(78,4-78,8)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.pos)
(HasType (FStar.Int.ones @x0)
(FStar.Int.int_t @x0)))
 

:pattern ((FStar.Int.ones @x0))
:qid typing_FStar.Int.ones))

:named typing_FStar.Int.ones))
;;;;;;;;;;;;;;;;Equation for FStar.Int.ones
;;; Fact-ids: Name FStar.Int.ones; Namespace FStar.Int
(assert (! 
;; def=FStar.Int.fsti(78,4-78,8); use=FStar.Int.fsti(78,4-78,8)
(forall ((@x0 Term))
...
:pattern ((FStar.Int.ones @x0))
:qid equation_FStar.Int.ones))

:named equation_FStar.Int.ones))
...
;;;;;;;;;;;;;;;;Equation for FStar.Int.from_uint
;;; Fact-ids: Name FStar.Int.from_uint; Namespace FStar.Int
(assert (! 
;; def=FStar.Int.fsti(193,4-193,13); use=FStar.Int.fsti(193,4-193,13)
(forall ((@x0 Term) (@x1 Term))
 (! (= (FStar.Int.from_uint @x0
@x1)
(let ((@lb2 (Prims.op_LessThanOrEqual @x1
(FStar.Int.max_int @x0))))
(ite (= @lb2
(BoxBool true))
@x1
...
:pattern ((FStar.Int.from_uint @x0
@x1))
:qid equation_FStar.Int.from_uint))

:named equation_FStar.Int.from_uint))
...
;;;;;;;;;;;;;;;;Lemma: FStar.Int.to_uint_injective
;;; Fact-ids: Name FStar.Int.to_uint_injective; Namespace FStar.Int
...
;; def=FStar.Int.fsti(197,20-197,46); use=FStar.Int.fst(58,4-58,21)
(= (FStar.Int.from_uint @x0
(FStar.Int.to_uint @x0
@x1))
@x1)
...
:pattern ((FStar.Int.to_uint @x0
@x1))
:qid lemma_FStar.Int.to_uint_injective))
:named lemma_FStar.Int.to_uint_injective))
...
(declare-fun Tm_refine_fae52e146c90244d6a2517e3274edeb3 (Term) Term)
...
; encoding sigelt pow2_from_vec_lemma


; <Skipped FStar.Int.pow2_from_vec_lemma/>
...
; encoding sigelt ones_to_vec_lemma


; <Skipped FStar.Int.ones_to_vec_lemma/>


; Starting query at FStar.Int.fst(100,29-100,31)
...
; Encoding query formula : forall (n: Prims.pos) (i: Prims.nat{i < n}).
;   (*could not prove post-condition*)
;   forall (p: Prims.pure_post Prims.unit).
;     (forall (pure_result: Prims.unit).
;         FStar.Seq.Base.index (FStar.Int.to_vec (FStar.Int.ones n)) i =
...
;; def=prims.fst(420,36-420,97); use=FStar.Int.fst(100,29-100,31)
(forall ((@x3 Term))
 (! (implies (and (or label_1
(HasType @x3
Prims.unit))

;; def=FStar.Int.fsti(261,17-261,66); use=FStar.Int.fst(100,29-100,31)
(or label_2
...
;; def=prims.fst(420,83-420,96); use=FStar.Int.fst(100,29-100,31)
(Valid 
;; def=prims.fst(420,83-420,96); use=FStar.Int.fst(100,29-100,31)
(ApplyTT @x2
@x3)
